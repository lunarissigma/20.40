...
{
public:
	class AFortPlayerPawn*                        TargetPawn;                                        // 0x0948(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AGCL_Cornfield_Movement_C) == 0x000950, "Wrong size on AGCL_Cornfield_Movement_C");
static_assert(offsetof(AGCL_Cornfield_Movement_C, TargetPawn) == 0x000948, "Member 'AGCL_Cornfield_Movement_C::TargetPawn' has a wrong offset!");
