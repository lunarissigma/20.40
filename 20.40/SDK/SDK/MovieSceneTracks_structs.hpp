...
static_assert(sizeof(FMovieSceneActorReferenceData) == 0x0000F0, "Wrong size on FMovieSceneActorReferenceData");
...
public:
	...
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0038(0x00F0)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieSceneActorReferenceSectionTemplate) == 0x000128, "Wrong size on FMovieSceneActorReferenceSectionTemplate");
...
static_assert(sizeof(FMovieSceneSkeletalAnimationParams) == 0x000120, "Wrong size on FMovieSceneSkeletalAnimationParams");
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bSkipAnimNotifiers) == 0x000110, "Member 'FMovieSceneSkeletalAnimationParams::bSkipAnimNotifiers' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bForceCustomMode) == 0x000111, "Member 'FMovieSceneSkeletalAnimationParams::bForceCustomMode' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, StartOffset) == 0x000114, "Member 'FMovieSceneSkeletalAnimationParams::StartOffset' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, EndOffset) == 0x000118, "Member 'FMovieSceneSkeletalAnimationParams::EndOffset' has a wrong offset!");
...
{
public:
	struct FFrameNumber                           SectionStartTime;                                  // 0x0120(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           SectionEndTime;                                    // 0x0124(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplateParameters) == 0x000128, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplateParameters");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionStartTime) == 0x000120, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionStartTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneSkeletalAnimationSectionTemplateParameters, SectionEndTime) == 0x000124, "Member 'FMovieSceneSkeletalAnimationSectionTemplateParameters::SectionEndTime' has a wrong offset!");
...
{
public:
	struct FMovieSceneSkeletalAnimationSectionTemplateParameters Params;                             // 0x0020(0x0128)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FMovieSceneSkeletalAnimationSectionTemplate) == 0x000148, "Wrong size on FMovieSceneSkeletalAnimationSectionTemplate");
