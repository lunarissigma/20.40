...
static_assert(sizeof(UBuildWatermark_C) == 0x000300, "Wrong size on UBuildWatermark_C");
static_assert(offsetof(UBuildWatermark_C, UberGraphFrame) == 0x0002F8, "Member 'UBuildWatermark_C::UberGraphFrame' has a wrong offset!");
