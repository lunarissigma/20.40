...
public:
	...
	TArray<TSubclassOf<class AActor>>             LoadedActorDataClass;                              // 0x0310(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UWorld*                                 CachedWorld;                                       // 0x0320(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaLivingWorldConfigData*       CachedConfig;                                      // 0x0328(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UFortAthenaLivingWorldEncounterInstance*> RunningEncounterInstances;                // 0x0330(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	class UFortSeasonalEventManager*              CachedSeasonalEventManager;                        // 0x0340(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FFortAthenaLivingWorldPlayerTracker    PlayerTracker;                                     // 0x0358(0x00B0)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_408[0x208];                                    // 0x0408(0x0208)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         RuntimePointProviderList;                          // 0x0610(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	TSet<class AActor*>                           RuntimePointProviderOwners;                        // 0x0620(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_670[0x1F8];                                    // 0x0670(0x01F8)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<TSubclassOf<class UFortAthenaLivingWorldSpawnAction>, class UFortAthenaLivingWorldSpawnAction*> SpawnActionCache; // 0x0868(0x0050)(Transient, NativeAccessSpecifierPrivate)
	class AActor*                                 EQSHelper;                                         // 0x08B8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaLivingWorldDebugDensityMiniMapIndicator* DebugDensityMinimapIndicator;          // 0x08C0(0x0008)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortAthenaLivingWorldManager) == 0x0008D0, "Wrong size on UFortAthenaLivingWorldManager");
...
static_assert(offsetof(UFortAthenaLivingWorldManager, LoadedActorDataClass) == 0x000310, "Member 'UFortAthenaLivingWorldManager::LoadedActorDataClass' has a wrong offset!");
...
static_assert(offsetof(UFortAthenaLivingWorldManager, PlayerTracker) == 0x000358, "Member 'UFortAthenaLivingWorldManager::PlayerTracker' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, RuntimePointProviderList) == 0x000610, "Member 'UFortAthenaLivingWorldManager::RuntimePointProviderList' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, RuntimePointProviderOwners) == 0x000620, "Member 'UFortAthenaLivingWorldManager::RuntimePointProviderOwners' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, SpawnActionCache) == 0x000868, "Member 'UFortAthenaLivingWorldManager::SpawnActionCache' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, EQSHelper) == 0x0008B8, "Member 'UFortAthenaLivingWorldManager::EQSHelper' has a wrong offset!");
static_assert(offsetof(UFortAthenaLivingWorldManager, DebugDensityMinimapIndicator) == 0x0008C0, "Member 'UFortAthenaLivingWorldManager::DebugDensityMinimapIndicator' has a wrong offset!");
