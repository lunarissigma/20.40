...
static_assert(sizeof(UTournamentModal_C) == 0x000548, "Wrong size on UTournamentModal_C");
static_assert(offsetof(UTournamentModal_C, UberGraphFrame) == 0x000530, "Member 'UTournamentModal_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTournamentModal_C, Intro) == 0x000538, "Member 'UTournamentModal_C::Intro' has a wrong offset!");
static_assert(offsetof(UTournamentModal_C, Image_BG) == 0x000540, "Member 'UTournamentModal_C::Image_BG' has a wrong offset!");
