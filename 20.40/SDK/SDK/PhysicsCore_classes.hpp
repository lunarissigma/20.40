...
static_assert(offsetof(UPhysicsSettingsCore, bEnableShapeSharing) == 0x000048, "Member 'UPhysicsSettingsCore::bEnableShapeSharing' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnablePCM) == 0x000049, "Member 'UPhysicsSettingsCore::bEnablePCM' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnableStabilization) == 0x00004A, "Member 'UPhysicsSettingsCore::bEnableStabilization' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bWarnMissingLocks) == 0x00004B, "Member 'UPhysicsSettingsCore::bWarnMissingLocks' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bEnable2DPhysics) == 0x00004C, "Member 'UPhysicsSettingsCore::bEnable2DPhysics' has a wrong offset!");
static_assert(offsetof(UPhysicsSettingsCore, bDefaultHasComplexCollision) == 0x00004D, "Member 'UPhysicsSettingsCore::bDefaultHasComplexCollision' has a wrong offset!");
