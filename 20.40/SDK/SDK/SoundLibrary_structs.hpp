...
public:
	struct FGameplayTag                           EventName;                                         // 0x0000(0x0004)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AttachName;                                        // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAttachLocation                               LocationType;                                      // 0x0008(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                Location;                                          // 0x0010(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VolumeMultiplier;                                  // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PitchMultiplier;                                   // 0x002C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         StartTime;                                         // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class USoundConcurrency*                      ConcurrencySettings;                               // 0x0038(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0040(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bStopWhenAttachedDestroyed;                        // 0x0048(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAutoDestroy;                                      // 0x0049(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAttachedSoundLibraryContextSettings) == 0x000050, "Wrong size on FAttachedSoundLibraryContextSettings");
...
static_assert(offsetof(FAttachedSoundLibraryContextSettings, AttachName) == 0x000004, "Member 'FAttachedSoundLibraryContextSettings::AttachName' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, LocationType) == 0x000008, "Member 'FAttachedSoundLibraryContextSettings::LocationType' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, Location) == 0x000010, "Member 'FAttachedSoundLibraryContextSettings::Location' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, VolumeMultiplier) == 0x000028, "Member 'FAttachedSoundLibraryContextSettings::VolumeMultiplier' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, PitchMultiplier) == 0x00002C, "Member 'FAttachedSoundLibraryContextSettings::PitchMultiplier' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, StartTime) == 0x000030, "Member 'FAttachedSoundLibraryContextSettings::StartTime' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, ConcurrencySettings) == 0x000038, "Member 'FAttachedSoundLibraryContextSettings::ConcurrencySettings' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, AttenuationSettings) == 0x000040, "Member 'FAttachedSoundLibraryContextSettings::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, bStopWhenAttachedDestroyed) == 0x000048, "Member 'FAttachedSoundLibraryContextSettings::bStopWhenAttachedDestroyed' has a wrong offset!");
static_assert(offsetof(FAttachedSoundLibraryContextSettings, bAutoDestroy) == 0x000049, "Member 'FAttachedSoundLibraryContextSettings::bAutoDestroy' has a wrong offset!");
