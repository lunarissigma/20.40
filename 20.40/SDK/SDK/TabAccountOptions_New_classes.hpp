...
static_assert(sizeof(UTabAccountOptions_New_C) == 0x000408, "Wrong size on UTabAccountOptions_New_C");
static_assert(offsetof(UTabAccountOptions_New_C, UberGraphFrame) == 0x000400, "Member 'UTabAccountOptions_New_C::UberGraphFrame' has a wrong offset!");
