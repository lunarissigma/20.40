...
public:
	...
	bool                                          bAllowPreviewStyles;                               // 0x0029(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FFortProgressiveVariant, bAllowPreviewStyles) == 0x000029, "Member 'FFortProgressiveVariant::bAllowPreviewStyles' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UObject>                 TileMaterial;                                      // 0x0018(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FFortProgressiveStageOverrideDisplayData, DisplayName) == 0x000000, "Member 'FFortProgressiveStageOverrideDisplayData::DisplayName' has a wrong offset!");
static_assert(offsetof(FFortProgressiveStageOverrideDisplayData, TileMaterial) == 0x000018, "Member 'FFortProgressiveStageOverrideDisplayData::TileMaterial' has a wrong offset!");
