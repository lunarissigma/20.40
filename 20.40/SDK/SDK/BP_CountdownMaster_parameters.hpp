...
public:
	...
	class ABP_Generic_TimerManager_C*             K2Node_DynamicCast_AsBP_Generic_Timer_Manager;     // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x0140(0x00E0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(sizeof(BP_CountdownMaster_C_SetHologramRelativeTransform) == 0x000220, "Wrong size on BP_CountdownMaster_C_SetHologramRelativeTransform");
...
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_BreakVector_Y) == 0x00001C, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_BreakVector_Z) == 0x000020, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x000028, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000108, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_Divide_VectorFloat_ReturnValue) == 0x000110, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_Divide_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_MakeVector_ReturnValue_1) == 0x000128, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_MakeVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_CountdownMaster_C_SetHologramRelativeTransform, CallFunc_K2_SetRelativeLocation_SweepHitResult_1) == 0x000140, "Member 'BP_CountdownMaster_C_SetHologramRelativeTransform::CallFunc_K2_SetRelativeLocation_SweepHitResult_1' has a wrong offset!");
