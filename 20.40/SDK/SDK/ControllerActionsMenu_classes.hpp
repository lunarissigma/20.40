...
static_assert(sizeof(UControllerActionsMenu_C) == 0x000520, "Wrong size on UControllerActionsMenu_C");
static_assert(offsetof(UControllerActionsMenu_C, UberGraphFrame) == 0x000518, "Member 'UControllerActionsMenu_C::UberGraphFrame' has a wrong offset!");
