...
static_assert(sizeof(AOnlineBeacon) == 0x0002A0, "Wrong size on AOnlineBeacon");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionInitialTimeout) == 0x000278, "Member 'AOnlineBeacon::BeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, BeaconConnectionTimeout) == 0x00027C, "Member 'AOnlineBeacon::BeaconConnectionTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x000280, "Member 'AOnlineBeacon::NetDriver' has a wrong offset!");
...
public:
	...
	EBeaconConnectionState                        ConnectionState;                                   // 0x02B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AOnlineBeaconClient) == 0x000300, "Wrong size on AOnlineBeaconClient");
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0002A0, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0002A8, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0002B0, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeaconHostObject) == 0x000298, "Wrong size on AOnlineBeaconHostObject");
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x000270, "Member 'AOnlineBeaconHostObject::BeaconTypeName' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x000280, "Member 'AOnlineBeaconHostObject::ClientBeaconActorClass' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x000288, "Member 'AOnlineBeaconHostObject::ClientActors' has a wrong offset!");
...
static_assert(sizeof(ASpectatorBeaconHost) == 0x000310, "Wrong size on ASpectatorBeaconHost");
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x000298, "Member 'ASpectatorBeaconHost::State' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, bLogoutOnSessionTimeout) == 0x000300, "Member 'ASpectatorBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, SessionTimeoutSecs) == 0x000304, "Member 'ASpectatorBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconHost, TravelSessionTimeoutSecs) == 0x000308, "Member 'ASpectatorBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3238[0x50];                                    // 0x3238(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SocketErrorDisconnectDelay;                        // 0x3288(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_328C[0x54];                                    // 0x328C(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x003288, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
static_assert(sizeof(UIpNetDriver) == 0x0007C8, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x00071C, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x00072C, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x000730, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x000734, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x000738, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x000740, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x000748, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ResolutionConnectionTimeout) == 0x00074C, "Member 'UIpNetDriver::ResolutionConnectionTimeout' has a wrong offset!");
...
{
public:
	int32                                         ListenPort;                                        // 0x02A0(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAuthRequired;                                     // 0x02A4(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2A5[0x3];                                      // 0x02A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint32                                        MaxAuthTokenSize;                                  // 0x02A8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2AC[0x54];                                     // 0x02AC(0x0054)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x0300(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AOnlineBeaconHost) == 0x0003B0, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x0002A0, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, bAuthRequired) == 0x0002A4, "Member 'AOnlineBeaconHost::bAuthRequired' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, MaxAuthTokenSize) == 0x0002A8, "Member 'AOnlineBeaconHost::MaxAuthTokenSize' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x000300, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
public:
	...
	EClientRequestType                            RequestType;                                       // 0x0390(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APartyBeaconClient) == 0x0003C0, "Wrong size on APartyBeaconClient");
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x000330, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x000340, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x000390, "Member 'APartyBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bPendingReservationSent) == 0x000391, "Member 'APartyBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, bCancelReservation) == 0x000392, "Member 'APartyBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(APartyBeaconHost) == 0x000310, "Wrong size on APartyBeaconHost");
static_assert(offsetof(APartyBeaconHost, State) == 0x000298, "Member 'APartyBeaconHost::State' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, bLogoutOnSessionTimeout) == 0x000300, "Member 'APartyBeaconHost::bLogoutOnSessionTimeout' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, SessionTimeoutSecs) == 0x000304, "Member 'APartyBeaconHost::SessionTimeoutSecs' has a wrong offset!");
static_assert(offsetof(APartyBeaconHost, TravelSessionTimeoutSecs) == 0x000308, "Member 'APartyBeaconHost::TravelSessionTimeoutSecs' has a wrong offset!");
...
public:
	...
	ESpectatorClientRequestType                   RequestType;                                       // 0x03B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ASpectatorBeaconClient) == 0x0003E8, "Wrong size on ASpectatorBeaconClient");
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x000330, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x000340, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x0003B8, "Member 'ASpectatorBeaconClient::RequestType' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bPendingReservationSent) == 0x0003B9, "Member 'ASpectatorBeaconClient::bPendingReservationSent' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, bCancelReservation) == 0x0003BA, "Member 'ASpectatorBeaconClient::bCancelReservation' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000300, "Wrong size on ATestBeaconClient");
...
static_assert(sizeof(ATestBeaconHost) == 0x000298, "Wrong size on ATestBeaconHost");
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0007D0, "Wrong size on UVoipListenerSynthComponent");
