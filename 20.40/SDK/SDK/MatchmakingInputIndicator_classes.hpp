...
public:
	...
	class UImage*                                 InputIcon;                                         // 0x02E8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UMatchmakingInputIndicator_C) == 0x0002F0, "Wrong size on UMatchmakingInputIndicator_C");
static_assert(offsetof(UMatchmakingInputIndicator_C, UberGraphFrame) == 0x0002E0, "Member 'UMatchmakingInputIndicator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMatchmakingInputIndicator_C, InputIcon) == 0x0002E8, "Member 'UMatchmakingInputIndicator_C::InputIcon' has a wrong offset!");
