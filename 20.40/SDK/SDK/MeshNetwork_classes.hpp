...
public:
	...
	TMap<class FName, double>                     AggregationTimeouts;                               // 0x00F8(0x0050)(NativeAccessSpecifierPrivate)
	TSet<class FName>                             NoAggregationFunctions;                            // 0x0148(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FNoAggregationParameters> NoAggregationParameters;                      // 0x0198(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FAggregatedFunctionConfig> AggregatedFunctionConfigs;                   // 0x01E8(0x0050)(Edit, EditConst, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMeshNetworkComponent) == 0x000240, "Wrong size on UMeshNetworkComponent");
...
static_assert(offsetof(UMeshNetworkComponent, AggregationTimeouts) == 0x0000F8, "Member 'UMeshNetworkComponent::AggregationTimeouts' has a wrong offset!");
static_assert(offsetof(UMeshNetworkComponent, NoAggregationFunctions) == 0x000148, "Member 'UMeshNetworkComponent::NoAggregationFunctions' has a wrong offset!");
static_assert(offsetof(UMeshNetworkComponent, NoAggregationParameters) == 0x000198, "Member 'UMeshNetworkComponent::NoAggregationParameters' has a wrong offset!");
static_assert(offsetof(UMeshNetworkComponent, AggregatedFunctionConfigs) == 0x0001E8, "Member 'UMeshNetworkComponent::AggregatedFunctionConfigs' has a wrong offset!");
