...
static_assert(sizeof(USquadMarker_C) == 0x000710, "Wrong size on USquadMarker_C");
static_assert(offsetof(USquadMarker_C, UberGraphFrame) == 0x000708, "Member 'USquadMarker_C::UberGraphFrame' has a wrong offset!");
