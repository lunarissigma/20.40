...
public:
	...
	TArray<class UStaticMesh*>                    StaticMeshAlternateArray;                          // 0x0F88(0x0010)(Edit, BlueprintVisible)
...
static_assert(sizeof(APBW_BP_Parent_C) == 0x000F98, "Wrong size on APBW_BP_Parent_C");
static_assert(offsetof(APBW_BP_Parent_C, UberGraphFrame) == 0x000F80, "Member 'APBW_BP_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(APBW_BP_Parent_C, StaticMeshAlternateArray) == 0x000F88, "Member 'APBW_BP_Parent_C::StaticMeshAlternateArray' has a wrong offset!");
