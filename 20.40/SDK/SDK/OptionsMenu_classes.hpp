...
public:
	...
	class UFortHUDElementWrapper_C*               FortHUDElementWrapper;                             // 0x0FE8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UTabGamePadConfig_v3_C*                 TabGamepadConfig;                                  // 0x0FF0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UOptionsMenu_C) == 0x001000, "Wrong size on UOptionsMenu_C");
static_assert(offsetof(UOptionsMenu_C, UberGraphFrame) == 0x000FE0, "Member 'UOptionsMenu_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, FortHUDElementWrapper) == 0x000FE8, "Member 'UOptionsMenu_C::FortHUDElementWrapper' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, TabGamepadConfig) == 0x000FF0, "Member 'UOptionsMenu_C::TabGamepadConfig' has a wrong offset!");
