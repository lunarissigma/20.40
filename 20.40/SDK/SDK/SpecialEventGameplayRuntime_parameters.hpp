...
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortAthenaLoadout                     ReturnValue;                                       // 0x0008(0x0160)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(SpecialEventGameplayLibrary_GetLocalPlayerLoadout) == 0x000168, "Wrong size on SpecialEventGameplayLibrary_GetLocalPlayerLoadout");
