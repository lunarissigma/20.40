...
void UMotionWarpingComponent::AddOrUpdateWarpTarget(class FName WarpTargetName, const struct FMotionWarpingTarget& WarpTarget)
{
	static class UFunction* Func = nullptr;
...
// const struct FTransform&                InWarpPointAnimTransform                               (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
class URootMotionModifier_AdjustmentBlendWarp* URootMotionModifier_AdjustmentBlendWarp::AddRootMotionModifierAdjustmentBlendWarp(class UMotionWarpingComponent* InMotionWarpingComp, const class UAnimSequenceBase* InAnimation, float InStartTime, float InEndTime, class FName InWarpTargetName, EWarpPointAnimProvider InWarpPointAnimProvider, const struct FTransform& InWarpPointAnimTransform, class FName InWarpPointAnimBoneName, bool bInWarpTranslation, bool bInIgnoreZAxis, bool bInWarpRotation, bool bInWarpIKBones, const TArray<class FName>& InIKBones)
{
	...
	Params::RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp Parms{};
...
void URootMotionModifier_AdjustmentBlendWarp::GetAdjustmentBlendIKBoneTransformAndAlpha(class ACharacter* Character, class FName BoneName, struct FTransform* OutTransform, float* OutAlpha)
{
	static class UFunction* Func = nullptr;
	...
	Params::RootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha Parms{};
