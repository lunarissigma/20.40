...
static_assert(sizeof(UMinimalSquadDisplay_C) == 0x0002C0, "Wrong size on UMinimalSquadDisplay_C");
static_assert(offsetof(UMinimalSquadDisplay_C, UberGraphFrame) == 0x0002B0, "Member 'UMinimalSquadDisplay_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMinimalSquadDisplay_C, SquadRibbon) == 0x0002B8, "Member 'UMinimalSquadDisplay_C::SquadRibbon' has a wrong offset!");
