...
public:
	...
	struct FGameplayTag                           TargetPropTeleportingCue;                          // 0x0B00(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayTag                           WobbleCue;                                         // 0x0B10(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	float                                         ServerWorldTime;                                   // 0x0B14(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           EnterCue;                                          // 0x0B18(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                           HidingInPropTag;                                   // 0x0B1C(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UGA_Athena_HidingProp_Teleport_C, ServerWorldTime) == 0x000B14, "Member 'UGA_Athena_HidingProp_Teleport_C::ServerWorldTime' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HidingProp_Teleport_C, EnterCue) == 0x000B18, "Member 'UGA_Athena_HidingProp_Teleport_C::EnterCue' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HidingProp_Teleport_C, HidingInPropTag) == 0x000B1C, "Member 'UGA_Athena_HidingProp_Teleport_C::HidingInPropTag' has a wrong offset!");
