...
public:
	...
	TMap<struct FGameplayTag, struct FCurieElementAttachHandlersContainer> ElementAttachmentHandlers; // 0x0350(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementAttachConditionHandlersContainer> ElementAttachmentConditionHandlers; // 0x03A0(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FCurieElementPairKey, struct FCurieElementInteractWithElementHandlersContainer> ElementInteractWithElementHandlers; // 0x03F0(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementInteractWithMaterialHandlersContainer> ElementInteractWithMaterialHandlers; // 0x0440(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementInteractWithContainerHandlersContainer> ElementInteractWithContainerHandlers; // 0x0490(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCurieManager) == 0x0005D0, "Wrong size on UCurieManager");
...
static_assert(offsetof(UCurieManager, ElementAttachmentHandlers) == 0x000350, "Member 'UCurieManager::ElementAttachmentHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentConditionHandlers) == 0x0003A0, "Member 'UCurieManager::ElementAttachmentConditionHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithElementHandlers) == 0x0003F0, "Member 'UCurieManager::ElementInteractWithElementHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithMaterialHandlers) == 0x000440, "Member 'UCurieManager::ElementInteractWithMaterialHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithContainerHandlers) == 0x000490, "Member 'UCurieManager::ElementInteractWithContainerHandlers' has a wrong offset!");
