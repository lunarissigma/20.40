...
void ABP_Generic_TimerManager_C::UseFakeTimer(float CountdownTime)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   Server_Seconds                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_Generic_TimerManager_C::DebugCountdown(float Server_Seconds)
{
	static class UFunction* Func = nullptr;
