...
{
public:
	class AFortTankVehicle*                       OwningTankVehicle;                                 // 0x0370(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MinTurretPitch;                                    // 0x0378(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxTurretPitch;                                    // 0x037C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDistanceMeterEnabled;                             // 0x0380(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bTankOrientationEventsEnabled;                     // 0x0381(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UTankVehicleReticle) == 0x000390, "Wrong size on UTankVehicleReticle");
static_assert(offsetof(UTankVehicleReticle, OwningTankVehicle) == 0x000370, "Member 'UTankVehicleReticle::OwningTankVehicle' has a wrong offset!");
static_assert(offsetof(UTankVehicleReticle, MinTurretPitch) == 0x000378, "Member 'UTankVehicleReticle::MinTurretPitch' has a wrong offset!");
static_assert(offsetof(UTankVehicleReticle, MaxTurretPitch) == 0x00037C, "Member 'UTankVehicleReticle::MaxTurretPitch' has a wrong offset!");
static_assert(offsetof(UTankVehicleReticle, bDistanceMeterEnabled) == 0x000380, "Member 'UTankVehicleReticle::bDistanceMeterEnabled' has a wrong offset!");
static_assert(offsetof(UTankVehicleReticle, bTankOrientationEventsEnabled) == 0x000381, "Member 'UTankVehicleReticle::bTankOrientationEventsEnabled' has a wrong offset!");
