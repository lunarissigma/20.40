...
static_assert(sizeof(UNiagaraDataInterfaceRasterizationGrid3D) == 0x000070, "Wrong size on UNiagaraDataInterfaceRasterizationGrid3D");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, Precision) == 0x000068, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::Precision' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceRasterizationGrid3D, ResetValue) == 0x00006C, "Member 'UNiagaraDataInterfaceRasterizationGrid3D::ResetValue' has a wrong offset!");
...
public:
	...
	ENiagaraSimStageExecuteBehavior               ExecuteBehavior;                                   // 0x00C4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bDisablePartialParticleUpdate : 1;                 // 0x00C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_C9[0x7];                                       // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraVariableDataInterfaceBinding   DataInterface;                                     // 0x00D0(0x0018)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraSimulationStageGeneric) == 0x0000E8, "Wrong size on UNiagaraSimulationStageGeneric");
...
static_assert(offsetof(UNiagaraSimulationStageGeneric, Iterations) == 0x00007C, "Member 'UNiagaraSimulationStageGeneric::Iterations' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, NumIterationsBinding) == 0x000080, "Member 'UNiagaraSimulationStageGeneric::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, ExecuteBehavior) == 0x0000C4, "Member 'UNiagaraSimulationStageGeneric::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraSimulationStageGeneric, DataInterface) == 0x0000D0, "Member 'UNiagaraSimulationStageGeneric::DataInterface' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneNiagaraParameterTrack) == 0x0000B8, "Wrong size on UMovieSceneNiagaraParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraBoolParameterTrack) == 0x0000C0, "Wrong size on UMovieSceneNiagaraBoolParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraColorParameterTrack) == 0x0000C0, "Wrong size on UMovieSceneNiagaraColorParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraFloatParameterTrack) == 0x0000C0, "Wrong size on UMovieSceneNiagaraFloatParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraIntegerParameterTrack) == 0x0000C0, "Wrong size on UMovieSceneNiagaraIntegerParameterTrack");
...
static_assert(sizeof(UMovieSceneNiagaraVectorParameterTrack) == 0x0000C8, "Wrong size on UMovieSceneNiagaraVectorParameterTrack");
static_assert(offsetof(UMovieSceneNiagaraVectorParameterTrack, ChannelsUsed) == 0x0000C0, "Member 'UMovieSceneNiagaraVectorParameterTrack::ChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(ANiagaraActor) == 0x000280, "Wrong size on ANiagaraActor");
static_assert(offsetof(ANiagaraActor, NiagaraComponent) == 0x000270, "Member 'ANiagaraActor::NiagaraComponent' has a wrong offset!");
...
public:
	...
	uint8                                         bRenderComponentOnly : 1;                          // 0x01BC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
{
public:
	class UNiagaraSystem*                         Asset;                                             // 0x0530(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         bForceSolo : 1;                                    // 0x0618(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	...
	uint8                                         BitPad_618_2 : 6;                                  // 0x0618(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_619[0x37];                                     // 0x0619(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAutoDestroy : 1;                                  // 0x0650(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bRenderingEnabled : 1;                             // 0x0650(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoManageAttachment : 1;                         // 0x0650(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAutoAttachWeldSimulatedBodies : 1;                // 0x0650(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_651[0x3];                                      // 0x0651(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTimeBeforeForceUpdateTransform;                 // 0x0654(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_658[0x8];                                      // 0x0658(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class UNiagaraComponent* PSystem)> OnSystemFinished;               // 0x0660(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class USceneComponent>         AutoAttachParent;                                  // 0x0670(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AutoAttachSocketName;                              // 0x0678(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_67F[0x9];                                      // 0x067F(0x0009)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_688_0 : 4;                                  // 0x0688(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bAllowScalability : 1;                             // 0x0688(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_689[0x12F];                                    // 0x0689(0x012F)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraCullProxyComponent*             CullProxy;                                         // 0x07B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x000530, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x000538, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x00053C, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x000540, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000654, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x000660, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x000670, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x000678, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x00067C, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x00067D, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x00067E, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, CullProxy) == 0x0007B8, "Member 'UNiagaraComponent::CullProxy' has a wrong offset!");
...
public:
	...
	bool                                          bMotionBlurEnabled;                                // 0x00A2(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A3[0x15];                                      // 0x00A3(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraRendererProperties, bMotionBlurEnabled) == 0x0000A2, "Member 'UNiagaraRendererProperties::bMotionBlurEnabled' has a wrong offset!");
...
{
public:
	TSubclassOf<class USceneComponent>            ComponentType;                                     // 0x00B8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FNiagaraVariableAttributeBinding       EnabledBinding;                                    // 0x00C8(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x0108(0x0040)(Edit, NativeAccessSpecifierPublic)
	bool                                          bAssignComponentsOnParticleID;                     // 0x0148(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyCreateComponentsOnParticleSpawn;              // 0x0149(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14A[0x2];                                      // 0x014A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         RendererVisibility;                                // 0x014C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USceneComponent*                        TemplateComponent;                                 // 0x0150(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraComponentPropertyBinding> PropertyBindings;                                // 0x0158(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraComponentRendererProperties) == 0x0001C8, "Wrong size on UNiagaraComponentRendererProperties");
...
static_assert(offsetof(UNiagaraComponentRendererProperties, bAssignComponentsOnParticleID) == 0x000148, "Member 'UNiagaraComponentRendererProperties::bAssignComponentsOnParticleID' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, bOnlyCreateComponentsOnParticleSpawn) == 0x000149, "Member 'UNiagaraComponentRendererProperties::bOnlyCreateComponentsOnParticleSpawn' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, RendererVisibility) == 0x00014C, "Member 'UNiagaraComponentRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, TemplateComponent) == 0x000150, "Member 'UNiagaraComponentRendererProperties::TemplateComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponentRendererProperties, PropertyBindings) == 0x000158, "Member 'UNiagaraComponentRendererProperties::PropertyBindings' has a wrong offset!");
...
static_assert(sizeof(UNiagaraCullProxyComponent) == 0x0007D0, "Wrong size on UNiagaraCullProxyComponent");
static_assert(offsetof(UNiagaraCullProxyComponent, Instances) == 0x0007C0, "Member 'UNiagaraCullProxyComponent::Instances' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfaceActorComponent) == 0x000070, "Wrong size on UNiagaraDataInterfaceActorComponent");
...
{
public:
	TArray<struct FNiagaraPosition>               PositionData;                                      // 0x0048(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraDataInterfaceCollisionQuery, MaxTracesPerParticle) == 0x000038, "Member 'UNiagaraDataInterfaceCollisionQuery::MaxTracesPerParticle' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceCollisionQuery, MaxRetraces) == 0x00003C, "Member 'UNiagaraDataInterfaceCollisionQuery::MaxRetraces' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamInt32, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamInt32::Min' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamInt32, Max) == 0x000034, "Member 'UNiagaraPreviewAxis_InterpParamInt32::Max' has a wrong offset!");
...
{
public:
	class FString                                 EmitterName;                                       // 0x0060(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 DIName;                                            // 0x0070(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceGrid2DCollectionReader) == 0x0000D0, "Wrong size on UNiagaraDataInterfaceGrid2DCollectionReader");
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollectionReader, EmitterName) == 0x000060, "Member 'UNiagaraDataInterfaceGrid2DCollectionReader::EmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceGrid2DCollectionReader, DIName) == 0x000070, "Member 'UNiagaraDataInterfaceGrid2DCollectionReader::DIName' has a wrong offset!");
...
public:
	...
	class USkeletalMeshComponent*                 SourceComponent;                                   // 0x0060(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class FName>                           FilteredBones;                                     // 0x0088(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FName>                           FilteredSockets;                                   // 0x0098(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	class FName                                   ExcludeBoneName;                                   // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bExcludeBone : 1;                                  // 0x00AC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_AD[0x3];                                       // 0x00AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         UvSetIndex;                                        // 0x00B0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRequireCurrentFrameData;                          // 0x00B4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNiagaraDataInterfaceSkeletalMesh) == 0x0000C0, "Wrong size on UNiagaraDataInterfaceSkeletalMesh");
...
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, UvSetIndex) == 0x0000B0, "Member 'UNiagaraDataInterfaceSkeletalMesh::UvSetIndex' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, bRequireCurrentFrameData) == 0x0000B4, "Member 'UNiagaraDataInterfaceSkeletalMesh::bRequireCurrentFrameData' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDebugHUDSettings) == 0x000270, "Wrong size on UNiagaraDebugHUDSettings");
...
public:
	...
	class FString                                 UniqueEmitterName;                                 // 0x0150(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraRendererProperties*>     RendererProperties;                                // 0x0160(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraEventScriptProperties>  EventHandlerScriptProps;                           // 0x0170(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class UNiagaraSimulationStageBase*>    SimulationStages;                                  // 0x0180(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UNiagaraScript*                         GPUComputeScript;                                  // 0x0190(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FName>                           SharedEventGeneratorIds;                           // 0x0198(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraEmitter) == 0x000288, "Wrong size on UNiagaraEmitter");
...
static_assert(offsetof(UNiagaraEmitter, UniqueEmitterName) == 0x000150, "Member 'UNiagaraEmitter::UniqueEmitterName' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, RendererProperties) == 0x000160, "Member 'UNiagaraEmitter::RendererProperties' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, EventHandlerScriptProps) == 0x000170, "Member 'UNiagaraEmitter::EventHandlerScriptProps' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SimulationStages) == 0x000180, "Member 'UNiagaraEmitter::SimulationStages' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, GPUComputeScript) == 0x000190, "Member 'UNiagaraEmitter::GPUComputeScript' has a wrong offset!");
static_assert(offsetof(UNiagaraEmitter, SharedEventGeneratorIds) == 0x000198, "Member 'UNiagaraEmitter::SharedEventGeneratorIds' has a wrong offset!");
...
// 0x0220 (0x02D8 - 0x00B8)
class UNiagaraLightRendererProperties final : public UNiagaraRendererProperties
{
public:
	uint8                                         bUseInverseSquaredFalloff : 1;                     // 0x00B8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAffectsTranslucency : 1;                          // 0x00B8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bAlphaScalesBrightness : 1;                        // 0x00B8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_B9[0x3];                                       // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RadiusScale;                                       // 0x00BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultExponent;                                   // 0x00C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C4[0x4];                                       // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                ColorAdd;                                          // 0x00C8(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraLightRendererProperties, RadiusScale) == 0x0000BC, "Member 'UNiagaraLightRendererProperties::RadiusScale' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, DefaultExponent) == 0x0000C0, "Member 'UNiagaraLightRendererProperties::DefaultExponent' has a wrong offset!");
static_assert(offsetof(UNiagaraLightRendererProperties, ColorAdd) == 0x0000C8, "Member 'UNiagaraLightRendererProperties::ColorAdd' has a wrong offset!");
...
public:
	...
	uint8                                         bSortOnlyWhenTranslucent : 1;                      // 0x00CC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bGpuLowLatencyTranslucency : 1;                    // 0x00CC(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	ENiagaraMeshFacingMode                        FacingMode;                                        // 0x00F0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F1[0x3];                                       // 0x00F1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bLockedAxisEnable : 1;                             // 0x00F4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	ENiagaraMeshLockedAxisSpace                   LockedAxisSpace;                                   // 0x0110(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x3];                                      // 0x0111(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinCameraDistance;                                 // 0x0114(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxCameraDistance;                                 // 0x0118(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        RendererVisibility;                                // 0x011C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PositionBinding;                                   // 0x0120(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ColorBinding;                                      // 0x0160(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       VelocityBinding;                                   // 0x01A0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MeshOrientationBinding;                            // 0x01E0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       ScaleBinding;                                      // 0x0220(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x0260(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x02A0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x02E0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x0320(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x0360(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x03A0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x03E0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0420(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x0460(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x04A0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MeshIndexBinding;                                  // 0x04E0(0x0040)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                       // 0x0520(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0530(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevScaleBinding;                                  // 0x0570(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevMeshOrientationBinding;                        // 0x05B0(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x05F0(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x0630(0x0040)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_670[0x68];                                     // 0x0670(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMesh*                            ParticleMesh;                                      // 0x06D8(0x0008)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector                                PivotOffset;                                       // 0x06E0(0x0018)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x06F8(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UNiagaraMeshRendererProperties) == 0x000700, "Wrong size on UNiagaraMeshRendererProperties");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, OverrideMaterials) == 0x0000D0, "Member 'UNiagaraMeshRendererProperties::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, SubImageSize) == 0x0000E0, "Member 'UNiagaraMeshRendererProperties::SubImageSize' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, FacingMode) == 0x0000F0, "Member 'UNiagaraMeshRendererProperties::FacingMode' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxis) == 0x0000F8, "Member 'UNiagaraMeshRendererProperties::LockedAxis' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, LockedAxisSpace) == 0x000110, "Member 'UNiagaraMeshRendererProperties::LockedAxisSpace' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MinCameraDistance) == 0x000114, "Member 'UNiagaraMeshRendererProperties::MinCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaxCameraDistance) == 0x000118, "Member 'UNiagaraMeshRendererProperties::MaxCameraDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibility) == 0x00011C, "Member 'UNiagaraMeshRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PositionBinding) == 0x000120, "Member 'UNiagaraMeshRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ColorBinding) == 0x000160, "Member 'UNiagaraMeshRendererProperties::ColorBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, ScaleBinding) == 0x000220, "Member 'UNiagaraMeshRendererProperties::ScaleBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial1Binding) == 0x0002E0, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial2Binding) == 0x000320, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, DynamicMaterial3Binding) == 0x000360, "Member 'UNiagaraMeshRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialRandomBinding) == 0x0003A0, "Member 'UNiagaraMeshRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CustomSortingBinding) == 0x0003E0, "Member 'UNiagaraMeshRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, NormalizedAgeBinding) == 0x000420, "Member 'UNiagaraMeshRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, CameraOffsetBinding) == 0x000460, "Member 'UNiagaraMeshRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, RendererVisibilityTagBinding) == 0x0004A0, "Member 'UNiagaraMeshRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MeshIndexBinding) == 0x0004E0, "Member 'UNiagaraMeshRendererProperties::MeshIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, MaterialParameterBindings) == 0x000520, "Member 'UNiagaraMeshRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevPositionBinding) == 0x000530, "Member 'UNiagaraMeshRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevScaleBinding) == 0x000570, "Member 'UNiagaraMeshRendererProperties::PrevScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevMeshOrientationBinding) == 0x0005B0, "Member 'UNiagaraMeshRendererProperties::PrevMeshOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevCameraOffsetBinding) == 0x0005F0, "Member 'UNiagaraMeshRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PrevVelocityBinding) == 0x000630, "Member 'UNiagaraMeshRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, ParticleMesh) == 0x0006D8, "Member 'UNiagaraMeshRendererProperties::ParticleMesh' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffset) == 0x0006E0, "Member 'UNiagaraMeshRendererProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraMeshRendererProperties, PivotOffsetSpace) == 0x0006F8, "Member 'UNiagaraMeshRendererProperties::PivotOffsetSpace' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPerfBaselineActor) == 0x000280, "Wrong size on ANiagaraPerfBaselineActor");
static_assert(offsetof(ANiagaraPerfBaselineActor, Controller) == 0x000270, "Member 'ANiagaraPerfBaselineActor::Controller' has a wrong offset!");
static_assert(offsetof(ANiagaraPerfBaselineActor, Label) == 0x000278, "Member 'ANiagaraPerfBaselineActor::Label' has a wrong offset!");
...
static_assert(sizeof(ANiagaraPreviewBase) == 0x000270, "Wrong size on ANiagaraPreviewBase");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamFloat, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamFloat::Min' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamFloat, Max) == 0x000034, "Member 'UNiagaraPreviewAxis_InterpParamFloat::Max' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector2D, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamVector2D::Min' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamVector::Min' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector, Max) == 0x000048, "Member 'UNiagaraPreviewAxis_InterpParamVector::Max' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamVector4, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamVector4::Min' has a wrong offset!");
...
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, Min) == 0x000030, "Member 'UNiagaraPreviewAxis_InterpParamLinearColor::Min' has a wrong offset!");
static_assert(offsetof(UNiagaraPreviewAxis_InterpParamLinearColor, Max) == 0x000040, "Member 'UNiagaraPreviewAxis_InterpParamLinearColor::Max' has a wrong offset!");
...
public:
	...
	ENiagaraPreviewGridResetMode                  ResetMode;                                         // 0x0278(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ANiagaraPreviewGrid) == 0x0002C0, "Wrong size on ANiagaraPreviewGrid");
static_assert(offsetof(ANiagaraPreviewGrid, System) == 0x000270, "Member 'ANiagaraPreviewGrid::System' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, ResetMode) == 0x000278, "Member 'ANiagaraPreviewGrid::ResetMode' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisX) == 0x000280, "Member 'ANiagaraPreviewGrid::PreviewAxisX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewAxisY) == 0x000288, "Member 'ANiagaraPreviewGrid::PreviewAxisY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewClass) == 0x000290, "Member 'ANiagaraPreviewGrid::PreviewClass' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingX) == 0x000298, "Member 'ANiagaraPreviewGrid::SpacingX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, SpacingY) == 0x00029C, "Member 'ANiagaraPreviewGrid::SpacingY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumX) == 0x0002A0, "Member 'ANiagaraPreviewGrid::NumX' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, NumY) == 0x0002A4, "Member 'ANiagaraPreviewGrid::NumY' has a wrong offset!");
static_assert(offsetof(ANiagaraPreviewGrid, PreviewComponents) == 0x0002A8, "Member 'ANiagaraPreviewGrid::PreviewComponents' has a wrong offset!");
...
{
public:
	class UMaterialInterface*                     Material;                                          // 0x00B8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x00C0(0x0018)(Edit, NativeAccessSpecifierPublic)
	ENiagaraRibbonFacingMode                      FacingMode;                                        // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraRibbonUVSettings               UV0Settings;                                       // 0x00E0(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FNiagaraRibbonUVSettings               UV1Settings;                                       // 0x0118(0x0038)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	ENiagaraRibbonDrawDirection                   DrawDirection;                                     // 0x0150(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonShapeMode                       Shape;                                             // 0x0151(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableAccurateGeometry;                           // 0x0152(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_153[0x1];                                      // 0x0153(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         WidthSegmentationCount;                            // 0x0154(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MultiPlaneCount;                                   // 0x0158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TubeSubdivisions;                                  // 0x015C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraRibbonShapeCustomVertex> CustomVertices;                                   // 0x0160(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	float                                         CurveTension;                                      // 0x0170(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraRibbonTessellationMode                TessellationMode;                                  // 0x0174(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_175[0x3];                                      // 0x0175(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TessellationFactor;                                // 0x0178(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseConstantFactor;                                // 0x017C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_17D[0x3];                                      // 0x017D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         TessellationAngle;                                 // 0x0180(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bScreenSpaceTessellation;                          // 0x0184(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                       // 0x0648(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_658[0xA0];                                     // 0x0658(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x0006F8, "Wrong size on UNiagaraRibbonRendererProperties");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, FacingMode) == 0x0000D8, "Member 'UNiagaraRibbonRendererProperties::FacingMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, UV1Settings) == 0x000118, "Member 'UNiagaraRibbonRendererProperties::UV1Settings' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DrawDirection) == 0x000150, "Member 'UNiagaraRibbonRendererProperties::DrawDirection' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, Shape) == 0x000151, "Member 'UNiagaraRibbonRendererProperties::Shape' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bEnableAccurateGeometry) == 0x000152, "Member 'UNiagaraRibbonRendererProperties::bEnableAccurateGeometry' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, WidthSegmentationCount) == 0x000154, "Member 'UNiagaraRibbonRendererProperties::WidthSegmentationCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MultiPlaneCount) == 0x000158, "Member 'UNiagaraRibbonRendererProperties::MultiPlaneCount' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TubeSubdivisions) == 0x00015C, "Member 'UNiagaraRibbonRendererProperties::TubeSubdivisions' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CustomVertices) == 0x000160, "Member 'UNiagaraRibbonRendererProperties::CustomVertices' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x000170, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x000174, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x000178, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x00017C, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x000180, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x000184, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialParameterBindings) == 0x000648, "Member 'UNiagaraRibbonRendererProperties::MaterialParameterBindings' has a wrong offset!");
...
public:
	...
	ETextureRenderTargetFormat                    DefaultRenderTargetFormat;                         // 0x00C0(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraGpuBufferFormat                       DefaultGridFormat;                                 // 0x00C1(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C2[0x2];                                       // 0x00C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	ENiagaraDefaultRendererMotionVectorSetting    DefaultRendererMotionVectorSetting;                // 0x00C4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_GpuMaxInfluences                 NDISkelMesh_GpuMaxInfluences;                      // 0x00C8(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_GpuUniformSamplingFormat         NDISkelMesh_GpuUniformSamplingFormat;              // 0x00C9(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENDISkelMesh_AdjacencyTriangleIndexFormat     NDISkelMesh_AdjacencyTriangleIndexFormat;          // 0x00CA(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UNiagaraSettings, PositionPinTypeColor) == 0x000050, "Member 'UNiagaraSettings::PositionPinTypeColor' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, QualityLevels) == 0x000060, "Member 'UNiagaraSettings::QualityLevels' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, ComponentRendererWarningsPerClass) == 0x000070, "Member 'UNiagaraSettings::ComponentRendererWarningsPerClass' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, DefaultRenderTargetFormat) == 0x0000C0, "Member 'UNiagaraSettings::DefaultRenderTargetFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, DefaultGridFormat) == 0x0000C1, "Member 'UNiagaraSettings::DefaultGridFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, DefaultRendererMotionVectorSetting) == 0x0000C4, "Member 'UNiagaraSettings::DefaultRendererMotionVectorSetting' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuMaxInfluences) == 0x0000C8, "Member 'UNiagaraSettings::NDISkelMesh_GpuMaxInfluences' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuUniformSamplingFormat) == 0x0000C9, "Member 'UNiagaraSettings::NDISkelMesh_GpuUniformSamplingFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_AdjacencyTriangleIndexFormat) == 0x0000CA, "Member 'UNiagaraSettings::NDISkelMesh_AdjacencyTriangleIndexFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, PlatformSetRedirects) == 0x0000D0, "Member 'UNiagaraSettings::PlatformSetRedirects' has a wrong offset!");

// Class Niagara.NiagaraSpriteRendererProperties
// 0x07C0 (0x0878 - 0x00B8)
...
public:
	...
	struct FNiagaraUserParameterBinding           MaterialUserParamBinding;                          // 0x00C8(0x0018)(Edit, NativeAccessSpecifierPublic)
	ENiagaraSpriteAlignment                       Alignment;                                         // 0x00E0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSpriteFacingMode                      FacingMode;                                        // 0x00E1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         MacroUVRadius;                                     // 0x00F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraSortMode                              SortMode;                                          // 0x00FC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bGpuLowLatencyTranslucency : 1;                    // 0x0110(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_111[0x3];                                      // 0x0111(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinFacingCameraBlendDistance;                      // 0x0114(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxFacingCameraBlendDistance;                      // 0x0118(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableCameraDistanceCulling : 1;                  // 0x011C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	struct FNiagaraVariableAttributeBinding       SpriteRotationBinding;                             // 0x01F0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteSizeBinding;                                 // 0x0230(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteFacingBinding;                               // 0x0270(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SpriteAlignmentBinding;                            // 0x02B0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       SubImageIndexBinding;                              // 0x02F0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterialBinding;                            // 0x0330(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial1Binding;                           // 0x0370(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial2Binding;                           // 0x03B0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       DynamicMaterial3Binding;                           // 0x03F0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CameraOffsetBinding;                               // 0x0430(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       UVScaleBinding;                                    // 0x0470(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PivotOffsetBinding;                                // 0x04B0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       MaterialRandomBinding;                             // 0x04F0(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       CustomSortingBinding;                              // 0x0530(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       NormalizedAgeBinding;                              // 0x0570(0x0040)(Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       RendererVisibilityTagBinding;                      // 0x05B0(0x0040)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FNiagaraMaterialAttributeBinding> MaterialParameterBindings;                       // 0x05F0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPositionBinding;                               // 0x0600(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevVelocityBinding;                               // 0x0640(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteRotationBinding;                         // 0x0680(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteSizeBinding;                             // 0x06C0(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteFacingBinding;                           // 0x0700(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevSpriteAlignmentBinding;                        // 0x0740(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevCameraOffsetBinding;                           // 0x0780(0x0040)(Transient, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding       PrevPivotOffsetBinding;                            // 0x07C0(0x0040)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_800[0x78];                                     // 0x0800(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSpriteRendererProperties) == 0x000878, "Wrong size on UNiagaraSpriteRendererProperties");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, SourceMode) == 0x0000C0, "Member 'UNiagaraSpriteRendererProperties::SourceMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, Alignment) == 0x0000E0, "Member 'UNiagaraSpriteRendererProperties::Alignment' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, FacingMode) == 0x0000E1, "Member 'UNiagaraSpriteRendererProperties::FacingMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, MacroUVRadius) == 0x0000F8, "Member 'UNiagaraSpriteRendererProperties::MacroUVRadius' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SortMode) == 0x0000FC, "Member 'UNiagaraSpriteRendererProperties::SortMode' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, MinFacingCameraBlendDistance) == 0x000114, "Member 'UNiagaraSpriteRendererProperties::MinFacingCameraBlendDistance' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaxFacingCameraBlendDistance) == 0x000118, "Member 'UNiagaraSpriteRendererProperties::MaxFacingCameraBlendDistance' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, ColorBinding) == 0x000170, "Member 'UNiagaraSpriteRendererProperties::ColorBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteSizeBinding) == 0x000230, "Member 'UNiagaraSpriteRendererProperties::SpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteFacingBinding) == 0x000270, "Member 'UNiagaraSpriteRendererProperties::SpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SpriteAlignmentBinding) == 0x0002B0, "Member 'UNiagaraSpriteRendererProperties::SpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, SubImageIndexBinding) == 0x0002F0, "Member 'UNiagaraSpriteRendererProperties::SubImageIndexBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterialBinding) == 0x000330, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial1Binding) == 0x000370, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial2Binding) == 0x0003B0, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, DynamicMaterial3Binding) == 0x0003F0, "Member 'UNiagaraSpriteRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CameraOffsetBinding) == 0x000430, "Member 'UNiagaraSpriteRendererProperties::CameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, UVScaleBinding) == 0x000470, "Member 'UNiagaraSpriteRendererProperties::UVScaleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PivotOffsetBinding) == 0x0004B0, "Member 'UNiagaraSpriteRendererProperties::PivotOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialRandomBinding) == 0x0004F0, "Member 'UNiagaraSpriteRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, CustomSortingBinding) == 0x000530, "Member 'UNiagaraSpriteRendererProperties::CustomSortingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, NormalizedAgeBinding) == 0x000570, "Member 'UNiagaraSpriteRendererProperties::NormalizedAgeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, RendererVisibilityTagBinding) == 0x0005B0, "Member 'UNiagaraSpriteRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, MaterialParameterBindings) == 0x0005F0, "Member 'UNiagaraSpriteRendererProperties::MaterialParameterBindings' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPositionBinding) == 0x000600, "Member 'UNiagaraSpriteRendererProperties::PrevPositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevVelocityBinding) == 0x000640, "Member 'UNiagaraSpriteRendererProperties::PrevVelocityBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteRotationBinding) == 0x000680, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteRotationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteSizeBinding) == 0x0006C0, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteFacingBinding) == 0x000700, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevSpriteAlignmentBinding) == 0x000740, "Member 'UNiagaraSpriteRendererProperties::PrevSpriteAlignmentBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevCameraOffsetBinding) == 0x000780, "Member 'UNiagaraSpriteRendererProperties::PrevCameraOffsetBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraSpriteRendererProperties, PrevPivotOffsetBinding) == 0x0007C0, "Member 'UNiagaraSpriteRendererProperties::PrevPivotOffsetBinding' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_418[0x138];                                    // 0x0418(0x0138)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNiagaraSystem) == 0x000550, "Wrong size on UNiagaraSystem");
