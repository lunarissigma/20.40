...
static_assert(sizeof(PetAnimLayerInterface_C_PetSkeletalControlLayer) == 0x000048, "Wrong size on PetAnimLayerInterface_C_PetSkeletalControlLayer");
...
static_assert(offsetof(PetAnimLayerInterface_C_PetSkeletalControlLayer, HandIKAlphaOverride) == 0x000034, "Member 'PetAnimLayerInterface_C_PetSkeletalControlLayer::HandIKAlphaOverride' has a wrong offset!");
static_assert(offsetof(PetAnimLayerInterface_C_PetSkeletalControlLayer, PetSkeletalControlLayer_0) == 0x000038, "Member 'PetAnimLayerInterface_C_PetSkeletalControlLayer::PetSkeletalControlLayer_0' has a wrong offset!");
