...
// Enum FortniteUI.ELockedWidgetsDisplayType
// NumValues: 0x0003
enum class ELockedWidgetsDisplayType : uint8
{
	LockedQuestsInBundles                    = 0,
	LockedBundlesInSchedules                 = 1,
	ELockedWidgetsDisplayType_MAX            = 2,
};

// Enum FortniteUI.ELockedWidgetUnlockType
// NumValues: 0x0004
enum class ELockedWidgetUnlockType : uint8
{
	QuestDaysFromEventStart                  = 0,
	QuestChallengesCompleteUntilUnlocked     = 1,
	BundleDaysFromEventStart                 = 2,
	ELockedWidgetUnlockType_MAX              = 3,
};

// Enum FortniteUI.ELockedWidgetDisplayQuantity
// NumValues: 0x0003
enum class ELockedWidgetDisplayQuantity : uint8
{
	ShowAll                                  = 0,
	ShowNextOnly                             = 1,
...
// Enum FortniteUI.ECollectionContainerEditTagsState
// NumValues: 0x0003
enum class ECollectionContainerEditTagsState : uint8
{
	SocialTagButtons                         = 0,
	SocialTagCollection                      = 1,
	ECollectionContainerEditTagsState_MAX    = 2,
};
...
public:
	...
	bool                                          bShowTopBar;                                       // 0x0001(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPrimaryContentSetup) == 0x000001, "Wrong alignment on FPrimaryContentSetup");
static_assert(sizeof(FPrimaryContentSetup) == 0x000002, "Wrong size on FPrimaryContentSetup");
...
static_assert(offsetof(FPrimaryContentSetup, bShowTopBar) == 0x000001, "Member 'FPrimaryContentSetup::bShowTopBar' has a wrong offset!");
...
{
public:
	struct FVideoWidgetConfig                     SizzleVideo;                                       // 0x0000(0x0080)(NativeAccessSpecifierPublic)
	TArray<class FText>                           InfoModalEntries;                                  // 0x0080(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FText                                   NewStagesUnlockFinePrint;                          // 0x0090(0x0018)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FAthenaSubscriptionProgressiveInfo) == 0x000008, "Wrong alignment on FAthenaSubscriptionProgressiveInfo");
static_assert(sizeof(FAthenaSubscriptionProgressiveInfo) == 0x0000A8, "Wrong size on FAthenaSubscriptionProgressiveInfo");
static_assert(offsetof(FAthenaSubscriptionProgressiveInfo, SizzleVideo) == 0x000000, "Member 'FAthenaSubscriptionProgressiveInfo::SizzleVideo' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionProgressiveInfo, InfoModalEntries) == 0x000080, "Member 'FAthenaSubscriptionProgressiveInfo::InfoModalEntries' has a wrong offset!");
static_assert(offsetof(FAthenaSubscriptionProgressiveInfo, NewStagesUnlockFinePrint) == 0x000090, "Member 'FAthenaSubscriptionProgressiveInfo::NewStagesUnlockFinePrint' has a wrong offset!");
...
public:
	...
	struct FAthenaSubscriptionProgressiveInfo     ProgressiveInfo;                                   // 0x00F8(0x00A8)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x01A0(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FCrewScreenData) == 0x000008, "Wrong alignment on FCrewScreenData");
static_assert(sizeof(FCrewScreenData) == 0x0001B0, "Wrong size on FCrewScreenData");
...
static_assert(offsetof(FCrewScreenData, SubModals) == 0x0001A0, "Member 'FCrewScreenData::SubModals' has a wrong offset!");
...
// ScriptStruct FortniteUI.LockedQuestData
// 0x0040 (0x0040 - 0x0000)
struct FLockedQuestData final
{
public:
	ELockedWidgetsDisplayType                     DisplayedWidgetsType;                              // 0x0000(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UMaterialInstance*                      DisplayIconOverride;                               // 0x0020(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ELockedWidgetDisplayQuantity                  DisplayQuantity;                                   // 0x0028(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ELockedWidgetUnlockType                       UnlockType;                                        // 0x0029(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A[0x6];                                       // 0x002A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	int64                                         UnlockNumber;                                      // 0x0030(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int64                                         UnlockUID;                                         // 0x0038(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FLockedQuestData) == 0x000008, "Wrong alignment on FLockedQuestData");
static_assert(sizeof(FLockedQuestData) == 0x000040, "Wrong size on FLockedQuestData");
static_assert(offsetof(FLockedQuestData, DisplayedWidgetsType) == 0x000000, "Member 'FLockedQuestData::DisplayedWidgetsType' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, DisplayName) == 0x000008, "Member 'FLockedQuestData::DisplayName' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, DisplayIconOverride) == 0x000020, "Member 'FLockedQuestData::DisplayIconOverride' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, DisplayQuantity) == 0x000028, "Member 'FLockedQuestData::DisplayQuantity' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, UnlockType) == 0x000029, "Member 'FLockedQuestData::UnlockType' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, UnlockNumber) == 0x000030, "Member 'FLockedQuestData::UnlockNumber' has a wrong offset!");
static_assert(offsetof(FLockedQuestData, UnlockUID) == 0x000038, "Member 'FLockedQuestData::UnlockUID' has a wrong offset!");
...
// 0x0038 (0x0038 - 0x0000)
struct FFortSocialProfileLanguageInfo final
{
public:
...
static_assert(alignof(FFortSocialProfileLanguageInfo) == 0x000008, "Wrong alignment on FFortSocialProfileLanguageInfo");
static_assert(sizeof(FFortSocialProfileLanguageInfo) == 0x000038, "Wrong size on FFortSocialProfileLanguageInfo");
static_assert(offsetof(FFortSocialProfileLanguageInfo, DisplayName) == 0x000000, "Member 'FFortSocialProfileLanguageInfo::DisplayName' has a wrong offset!");
static_assert(offsetof(FFortSocialProfileLanguageInfo, LanguageId) == 0x000018, "Member 'FFortSocialProfileLanguageInfo::LanguageId' has a wrong offset!");
static_assert(offsetof(FFortSocialProfileLanguageInfo, BackendId) == 0x000028, "Member 'FFortSocialProfileLanguageInfo::BackendId' has a wrong offset!");
...
public:
	...
	class FText                                   OverrideName;                                      // 0x0010(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObject>                 TileMaterial;                                      // 0x0028(0x0028)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FProgressiveStageItemInfo, OverrideName) == 0x000010, "Member 'FProgressiveStageItemInfo::OverrideName' has a wrong offset!");
static_assert(offsetof(FProgressiveStageItemInfo, TileMaterial) == 0x000028, "Member 'FProgressiveStageItemInfo::TileMaterial' has a wrong offset!");
...
// 0x0068 (0x0068 - 0x0000)
struct FQuestCategoryHeaderData final
{
public:
	class FText                                   HeaderName;                                        // 0x0000(0x0018)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTag                           HeaderTag;                                         // 0x0018(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  IncludedGameModeTags;                              // 0x0020(0x0020)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DisabledGameModeTags;                              // 0x0040(0x0020)(Edit, NativeAccessSpecifierPublic)
	int32                                         HeaderSortOrder;                                   // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FQuestCategoryHeaderData) == 0x000008, "Wrong alignment on FQuestCategoryHeaderData");
static_assert(sizeof(FQuestCategoryHeaderData) == 0x000068, "Wrong size on FQuestCategoryHeaderData");
static_assert(offsetof(FQuestCategoryHeaderData, HeaderName) == 0x000000, "Member 'FQuestCategoryHeaderData::HeaderName' has a wrong offset!");
static_assert(offsetof(FQuestCategoryHeaderData, HeaderTag) == 0x000018, "Member 'FQuestCategoryHeaderData::HeaderTag' has a wrong offset!");
static_assert(offsetof(FQuestCategoryHeaderData, IncludedGameModeTags) == 0x000020, "Member 'FQuestCategoryHeaderData::IncludedGameModeTags' has a wrong offset!");
static_assert(offsetof(FQuestCategoryHeaderData, DisabledGameModeTags) == 0x000040, "Member 'FQuestCategoryHeaderData::DisabledGameModeTags' has a wrong offset!");
static_assert(offsetof(FQuestCategoryHeaderData, HeaderSortOrder) == 0x000060, "Member 'FQuestCategoryHeaderData::HeaderSortOrder' has a wrong offset!");
...
// 0x0038 (0x0038 - 0x0000)
struct FFortSocialProfileRegionInfo final
{
public:
	class FText                                   DisplayName;                                       // 0x0000(0x0018)(Config, NativeAccessSpecifierPublic)
...
static_assert(alignof(FFortSocialProfileRegionInfo) == 0x000008, "Wrong alignment on FFortSocialProfileRegionInfo");
static_assert(sizeof(FFortSocialProfileRegionInfo) == 0x000038, "Wrong size on FFortSocialProfileRegionInfo");
static_assert(offsetof(FFortSocialProfileRegionInfo, DisplayName) == 0x000000, "Member 'FFortSocialProfileRegionInfo::DisplayName' has a wrong offset!");
static_assert(offsetof(FFortSocialProfileRegionInfo, RegionId) == 0x000018, "Member 'FFortSocialProfileRegionInfo::RegionId' has a wrong offset!");
static_assert(offsetof(FFortSocialProfileRegionInfo, BackendId) == 0x000028, "Member 'FFortSocialProfileRegionInfo::BackendId' has a wrong offset!");
...
{
public:
	class FName                                   FilterTabNameId;                                   // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0xC];                                        // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortTabButtonLabelInfo                TabButtonLabelInfo;                                // 0x0010(0x00E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TArray<EFortInventoryFilter>                  ItemFilters;                                       // 0x00F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EFortItemType                                 ItemType;                                          // 0x0100(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_101[0xF];                                      // 0x0101(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortItemTransformFilterTabLabelInfo) == 0x000010, "Wrong alignment on FFortItemTransformFilterTabLabelInfo");
static_assert(sizeof(FFortItemTransformFilterTabLabelInfo) == 0x000110, "Wrong size on FFortItemTransformFilterTabLabelInfo");
...
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, TabButtonLabelInfo) == 0x000010, "Member 'FFortItemTransformFilterTabLabelInfo::TabButtonLabelInfo' has a wrong offset!");
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemFilters) == 0x0000F0, "Member 'FFortItemTransformFilterTabLabelInfo::ItemFilters' has a wrong offset!");
static_assert(offsetof(FFortItemTransformFilterTabLabelInfo, ItemType) == 0x000100, "Member 'FFortItemTransformFilterTabLabelInfo::ItemType' has a wrong offset!");
