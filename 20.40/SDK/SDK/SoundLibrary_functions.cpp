...
// Parameters:
// struct FGameplayTag*                    OutEventName                                           (Parm, OutParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool USoundLibraryContext::PlaySound(class USoundBase* Sound, struct FSoundLibraryPlaySoundResult* OutResults) const
{
	static class UFunction* Func = nullptr;
