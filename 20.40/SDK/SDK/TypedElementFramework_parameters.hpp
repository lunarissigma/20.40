...
static_assert(offsetof(TypedElementListLibrary_CountElementsOfType, ReturnValue) == 0x000014, "Member 'TypedElementListLibrary_CountElementsOfType::ReturnValue' has a wrong offset!");

// Function TypedElementFramework.TypedElementListLibrary.CreateElementList
// 0x0018 (0x0018 - 0x0000)
struct TypedElementListLibrary_CreateElementList final
{
public:
...
static_assert(alignof(TypedElementListLibrary_CreateElementList) == 0x000008, "Wrong alignment on TypedElementListLibrary_CreateElementList");
static_assert(sizeof(TypedElementListLibrary_CreateElementList) == 0x000018, "Wrong size on TypedElementListLibrary_CreateElementList");
static_assert(offsetof(TypedElementListLibrary_CreateElementList, Registry) == 0x000000, "Member 'TypedElementListLibrary_CreateElementList::Registry' has a wrong offset!");
static_assert(offsetof(TypedElementListLibrary_CreateElementList, ReturnValue) == 0x000008, "Member 'TypedElementListLibrary_CreateElementList::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(TypedElementListLibrary_HasElementsOfType, ReturnValue) == 0x000014, "Member 'TypedElementListLibrary_HasElementsOfType::ReturnValue' has a wrong offset!");
