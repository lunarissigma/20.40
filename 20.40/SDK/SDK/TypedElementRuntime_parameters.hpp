...
public:
	struct FTypedElementHandle                    InElementHandle;                                   // 0x0000(0x0008)(ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAssetData                             ReturnValue;                                       // 0x0008(0x0048)(Parm, OutParm, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(TypedElementAssetDataInterface_GetAssetData) == 0x000050, "Wrong size on TypedElementAssetDataInterface_GetAssetData");
...
// 0x0018 (0x0018 - 0x0000)
struct TypedElementSelectionSet_GetSelectedElementHandles final
{
public:
	TSubclassOf<class IInterface>                 InBaseInterfaceType;                               // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(TypedElementSelectionSet_GetSelectedElementHandles) == 0x000008, "Wrong alignment on TypedElementSelectionSet_GetSelectedElementHandles");
static_assert(sizeof(TypedElementSelectionSet_GetSelectedElementHandles) == 0x000018, "Wrong size on TypedElementSelectionSet_GetSelectedElementHandles");
static_assert(offsetof(TypedElementSelectionSet_GetSelectedElementHandles, InBaseInterfaceType) == 0x000000, "Member 'TypedElementSelectionSet_GetSelectedElementHandles::InBaseInterfaceType' has a wrong offset!");
static_assert(offsetof(TypedElementSelectionSet_GetSelectedElementHandles, ReturnValue) == 0x000008, "Member 'TypedElementSelectionSet_GetSelectedElementHandles::ReturnValue' has a wrong offset!");
