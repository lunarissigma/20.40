...
static_assert(sizeof(FPartyMemberPlatformData) == 0x000090, "Wrong size on FPartyMemberPlatformData");
...
static_assert(offsetof(FPartyMemberPlatformData, SessionId) == 0x000080, "Member 'FPartyMemberPlatformData::SessionId' has a wrong offset!");
