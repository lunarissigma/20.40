...
public:
	...
	class USimpleCommonButton_C*                  Button_ControllerAction;                           // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USettingsListEntry_ControllerButton_C) == 0x000310, "Wrong size on USettingsListEntry_ControllerButton_C");
static_assert(offsetof(USettingsListEntry_ControllerButton_C, UberGraphFrame) == 0x000300, "Member 'USettingsListEntry_ControllerButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_ControllerButton_C, Button_ControllerAction) == 0x000308, "Member 'USettingsListEntry_ControllerButton_C::Button_ControllerAction' has a wrong offset!");
