...
static_assert(alignof(FRigVMExtendedExecuteContext) == 0x000010, "Wrong alignment on FRigVMExtendedExecuteContext");
static_assert(sizeof(FRigVMExtendedExecuteContext) == 0x0000A0, "Wrong size on FRigVMExtendedExecuteContext");
