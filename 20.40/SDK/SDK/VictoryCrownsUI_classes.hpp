...
{
public:
	TWeakObjectPtr<class AFortPlayerStateAthena>  WeakPSA;                                           // 0x02A0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonTextBlock*                       Text_PlayerName;                                   // 0x02A8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVictoryCrownsBearerInfoBase) == 0x0002B0, "Wrong size on UVictoryCrownsBearerInfoBase");
static_assert(offsetof(UVictoryCrownsBearerInfoBase, WeakPSA) == 0x0002A0, "Member 'UVictoryCrownsBearerInfoBase::WeakPSA' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsBearerInfoBase, Text_PlayerName) == 0x0002A8, "Member 'UVictoryCrownsBearerInfoBase::Text_PlayerName' has a wrong offset!");
...
static_assert(sizeof(UVictoryCrownsIndicator) == 0x000388, "Wrong size on UVictoryCrownsIndicator");
...
static_assert(sizeof(UVictoryCrownsPlacementOverlay) == 0x000300, "Wrong size on UVictoryCrownsPlacementOverlay");
...
static_assert(sizeof(UVictoryCrownsPlayerInfoWidget) == 0x0002F0, "Wrong size on UVictoryCrownsPlayerInfoWidget");
...
{
public:
	class UDynamicEntryBox*                       EntryBox_BearerList;                               // 0x03B8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonActionWidget*                    TipActionWidget;                                   // 0x03C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FDataTableRowHandle                    CloseObjectInputAction;                            // 0x03C8(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVictoryCrownsPreGameWidget) == 0x0003F0, "Wrong size on UVictoryCrownsPreGameWidget");
static_assert(offsetof(UVictoryCrownsPreGameWidget, EntryBox_BearerList) == 0x0003B8, "Member 'UVictoryCrownsPreGameWidget::EntryBox_BearerList' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsPreGameWidget, TipActionWidget) == 0x0003C0, "Member 'UVictoryCrownsPreGameWidget::TipActionWidget' has a wrong offset!");
static_assert(offsetof(UVictoryCrownsPreGameWidget, CloseObjectInputAction) == 0x0003C8, "Member 'UVictoryCrownsPreGameWidget::CloseObjectInputAction' has a wrong offset!");
