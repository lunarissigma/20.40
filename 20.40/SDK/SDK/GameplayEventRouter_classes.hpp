...
static_assert(sizeof(UAsyncAction_StartListeningToEvent) == 0x000078, "Wrong size on UAsyncAction_StartListeningToEvent");
...
static_assert(sizeof(UAsyncAction_StartListeningToStatefulEvent) == 0x000098, "Wrong size on UAsyncAction_StartListeningToStatefulEvent");
...
static_assert(alignof(IGameplayEventRouterOwnerInterface) == 0x000001, "Wrong alignment on IGameplayEventRouterOwnerInterface");
static_assert(sizeof(IGameplayEventRouterOwnerInterface) == 0x000001, "Wrong size on IGameplayEventRouterOwnerInterface");
