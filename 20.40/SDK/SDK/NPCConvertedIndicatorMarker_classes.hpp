...
{
public:
	class UImage*                                 IrwinIndicator;                                    // 0x05B0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UNPCConvertedIndicatorMarker_C) == 0x0005B8, "Wrong size on UNPCConvertedIndicatorMarker_C");
static_assert(offsetof(UNPCConvertedIndicatorMarker_C, IrwinIndicator) == 0x0005B0, "Member 'UNPCConvertedIndicatorMarker_C::IrwinIndicator' has a wrong offset!");
