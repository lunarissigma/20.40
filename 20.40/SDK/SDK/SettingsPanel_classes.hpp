...
{
public:
	class USafeZone*                              SafeZone_0;                                        // 0x06E8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USettingsPanel_C) == 0x0006F0, "Wrong size on USettingsPanel_C");
static_assert(offsetof(USettingsPanel_C, SafeZone_0) == 0x0006E8, "Member 'USettingsPanel_C::SafeZone_0' has a wrong offset!");
