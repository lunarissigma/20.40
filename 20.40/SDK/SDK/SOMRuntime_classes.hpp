...
static_assert(alignof(IFortScriptedObjectMovement_GridProviderInterface) == 0x000001, "Wrong alignment on IFortScriptedObjectMovement_GridProviderInterface");
static_assert(sizeof(IFortScriptedObjectMovement_GridProviderInterface) == 0x000001, "Wrong size on IFortScriptedObjectMovement_GridProviderInterface");
...
// 0x0210 (0x0B50 - 0x0940)
class AFortScriptedObjectMovement_MovableObjectBase final : public ABuildingGameplayActor
{
public:
	uint8                                         Pad_940[0x70];                                     // 0x0940(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Editor_SkipMasterPathIndex;                        // 0x09B0(0x0004)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Editor_SkipSubPathIndex;                           // 0x09B4(0x0004)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Editor_NumStepsPerClick;                           // 0x09B8(0x0004)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9BC[0x24];                                     // 0x09BC(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortScriptedObjectMovement_SlotDefinition* AssignedSlotDefinition;                        // 0x09E0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FScriptedObjectMovement_DynamicPathContext MovementPath;                                  // 0x09E8(0x0038)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_A20[0x8];                                      // 0x0A20(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UStaticMesh*                            ScriptedObjectMesh;                                // 0x0A28(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A30[0x18];                                     // 0x0A30(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bDebugStaticMovement;                              // 0x0A48(0x0001)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWaitingForBeginPlaySkip;                          // 0x0A49(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A4A[0x6];                                      // 0x0A4A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class AScriptedObjectMovement_StaticPath*     StaticFollowPath;                                  // 0x0A50(0x0008)(Edit, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_A58[0x8];                                      // 0x0A58(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScriptedObjectMovement_StaticPathStepData CurrentStepData;                               // 0x0A60(0x00F0)(BlueprintVisible, BlueprintReadOnly, Net, Transient, RepNotify, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AFortScriptedObjectMovement_MovableObjectBase) == 0x000B50, "Wrong size on AFortScriptedObjectMovement_MovableObjectBase");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, Editor_SkipMasterPathIndex) == 0x0009B0, "Member 'AFortScriptedObjectMovement_MovableObjectBase::Editor_SkipMasterPathIndex' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, Editor_SkipSubPathIndex) == 0x0009B4, "Member 'AFortScriptedObjectMovement_MovableObjectBase::Editor_SkipSubPathIndex' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, Editor_NumStepsPerClick) == 0x0009B8, "Member 'AFortScriptedObjectMovement_MovableObjectBase::Editor_NumStepsPerClick' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, AssignedSlotDefinition) == 0x0009E0, "Member 'AFortScriptedObjectMovement_MovableObjectBase::AssignedSlotDefinition' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, MovementPath) == 0x0009E8, "Member 'AFortScriptedObjectMovement_MovableObjectBase::MovementPath' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, ScriptedObjectMesh) == 0x000A28, "Member 'AFortScriptedObjectMovement_MovableObjectBase::ScriptedObjectMesh' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, bDebugStaticMovement) == 0x000A48, "Member 'AFortScriptedObjectMovement_MovableObjectBase::bDebugStaticMovement' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, bWaitingForBeginPlaySkip) == 0x000A49, "Member 'AFortScriptedObjectMovement_MovableObjectBase::bWaitingForBeginPlaySkip' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, StaticFollowPath) == 0x000A50, "Member 'AFortScriptedObjectMovement_MovableObjectBase::StaticFollowPath' has a wrong offset!");
static_assert(offsetof(AFortScriptedObjectMovement_MovableObjectBase, CurrentStepData) == 0x000A60, "Member 'AFortScriptedObjectMovement_MovableObjectBase::CurrentStepData' has a wrong offset!");
