...
public:
	...
	bool                                          bIsPrimaryBackgroundActive;                        // 0x0320(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AVaultWorld_C) == 0x000328, "Wrong size on AVaultWorld_C");
static_assert(offsetof(AVaultWorld_C, UberGraphFrame) == 0x000318, "Member 'AVaultWorld_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AVaultWorld_C, bIsPrimaryBackgroundActive) == 0x000320, "Member 'AVaultWorld_C::bIsPrimaryBackgroundActive' has a wrong offset!");
