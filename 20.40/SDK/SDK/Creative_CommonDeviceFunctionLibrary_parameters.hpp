...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_GetMID) == 0x0000B0, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_GetMID");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_GetDisplayName_ReturnValue) == 0x000020, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, K2Node_DynamicCast_AsMaterial_Instance_Dynamic) == 0x000030, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::K2Node_DynamicCast_AsMaterial_Instance_Dynamic' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000040, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_Conv_VectorToString_ReturnValue) == 0x000058, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_Conv_VectorToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_GetOwner_ReturnValue) == 0x000068, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_GetDisplayName_ReturnValue_1) == 0x000070, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_GetDisplayName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_Concat_StrStr_ReturnValue) == 0x000080, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_Concat_StrStr_ReturnValue_1) == 0x000090, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_Conv_StringToName_ReturnValue) == 0x0000A0, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x0000A8, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
...
public:
	...
	class FName                                   CallFunc_Conv_StringToName_ReturnValue;            // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial) == 0x0000C0, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000068, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_Conv_VectorToString_ReturnValue) == 0x000080, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_Conv_VectorToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_Concat_StrStr_ReturnValue) == 0x000090, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_Concat_StrStr_ReturnValue_1) == 0x0000A0, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_Concat_StrStr_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_Conv_StringToName_ReturnValue) == 0x0000B0, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x0000B8, "Member 'Creative_CommonDeviceFunctionLibrary_C_GetMID_FromMaterial::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
...
public:
	...
	class UObject*                                __WorldContext;                                    // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Enabled;                                           // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_InEditor_ReturnValue;                     // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Less_ByteByte_ReturnValue;                // 0x0025(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_InEditor_ReturnValue) == 0x000019, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_InEditor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_MakeLiteralByte_ReturnValue) == 0x00001A, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_MakeLiteralByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_Not_PreBool_ReturnValue) == 0x00001C, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_MakeLiteralByte_ReturnValue_1) == 0x00001D, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_MakeLiteralByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x00001E, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00001F, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanOR_ReturnValue) == 0x000023, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_IntInt_ReturnValue_1) == 0x000024, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_Less_ByteByte_ReturnValue) == 0x000025, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_Less_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000026, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_MakeLiteralByte_ReturnValue_2) == 0x000027, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_MakeLiteralByte_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_IntInt_ReturnValue_2) == 0x000028, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_ByteByte_ReturnValue_2) == 0x000029, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_ByteByte_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanAND_ReturnValue_2) == 0x00002A, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_IntInt_ReturnValue_3) == 0x00002C, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_EqualEqual_IntInt_ReturnValue_4) == 0x00002D, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_EqualEqual_IntInt_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanOR_ReturnValue_1) == 0x00002E, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanAND_ReturnValue_4) == 0x00002F, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanAND_ReturnValue_4' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanOR_ReturnValue_2) == 0x000031, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanOR_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanOR_ReturnValue_3) == 0x000032, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanOR_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch, CallFunc_BooleanOR_ReturnValue_4) == 0x000033, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsEnabledPhaseMatch::CallFunc_BooleanOR_ReturnValue_4' has a wrong offset!");
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_IsInEditor) == 0x000020, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_IsInEditor");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsInEditor, CallFunc_GetPlayerController_ReturnValue) == 0x000010, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsInEditor::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsInEditor, CallFunc_InEditorOrPIE_ReturnValue) == 0x000018, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsInEditor::CallFunc_InEditorOrPIE_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_IsInEditor, CallFunc_IsValid_ReturnValue) == 0x000019, "Member 'Creative_CommonDeviceFunctionLibrary_C_IsInEditor::CallFunc_IsValid_ReturnValue' has a wrong offset!");
