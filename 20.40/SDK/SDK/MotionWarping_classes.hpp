...
public:
	...
	TMap<class FName, struct FMotionWarpingTarget> WarpTargetMap;                                    // 0x00D0(0x0050)(Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)

public:
	void AddOrUpdateWarpTarget(class FName WarpTargetName, const struct FMotionWarpingTarget& WarpTarget);
...
static_assert(sizeof(UMotionWarpingComponent) == 0x000120, "Wrong size on UMotionWarpingComponent");
...
static_assert(offsetof(UMotionWarpingComponent, WarpTargetMap) == 0x0000D0, "Member 'UMotionWarpingComponent::WarpTargetMap' has a wrong offset!");
...
public:
	...
	struct FTransform                             StartTransform;                                    // 0x0050(0x0060)(BlueprintVisible, BlueprintReadOnly, Transient, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(URootMotionModifier, bInLocalSpace) == 0x000044, "Member 'URootMotionModifier::bInLocalSpace' has a wrong offset!");
...
public:
	...
	struct FTransform                             WarpPointAnimTransform;                            // 0x00F0(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	EMotionWarpRotationType                       RotationType;                                      // 0x0157(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FTransform                             CachedTargetTransform;                             // 0x0160(0x0060)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URootMotionModifier_Warp) == 0x000230, "Wrong size on URootMotionModifier_Warp");
...
static_assert(offsetof(URootMotionModifier_Warp, bWarpRotation) == 0x000156, "Member 'URootMotionModifier_Warp::bWarpRotation' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, RotationType) == 0x000157, "Member 'URootMotionModifier_Warp::RotationType' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, WarpRotationTimeMultiplier) == 0x000158, "Member 'URootMotionModifier_Warp::WarpRotationTimeMultiplier' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, CachedTargetTransform) == 0x000160, "Member 'URootMotionModifier_Warp::CachedTargetTransform' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SimpleWarp) == 0x000230, "Wrong size on URootMotionModifier_SimpleWarp");
...
public:
	...
	struct FTransform                             CachedMeshTransform;                               // 0x0250(0x0060)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FTransform                             CachedMeshRelativeTransform;                       // 0x02B0(0x0060)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FTransform                             CachedRootMotion;                                  // 0x0310(0x0060)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	static void GetAdjustmentBlendIKBoneTransformAndAlpha(class ACharacter* Character, class FName BoneName, struct FTransform* OutTransform, float* OutAlpha);
...
static_assert(sizeof(URootMotionModifier_AdjustmentBlendWarp) == 0x000390, "Wrong size on URootMotionModifier_AdjustmentBlendWarp");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, bWarpIKBones) == 0x000230, "Member 'URootMotionModifier_AdjustmentBlendWarp::bWarpIKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, IKBones) == 0x000238, "Member 'URootMotionModifier_AdjustmentBlendWarp::IKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshTransform) == 0x000250, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshRelativeTransform) == 0x0002B0, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshRelativeTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedRootMotion) == 0x000310, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedRootMotion' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, Result) == 0x000370, "Member 'URootMotionModifier_AdjustmentBlendWarp::Result' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SkewWarp) == 0x000230, "Wrong size on URootMotionModifier_SkewWarp");
