...
public:
	...
	class UIconTextButton_C*                      Button_Confirm;                                    // 0x0540(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(URestartClient_C) == 0x000548, "Wrong size on URestartClient_C");
static_assert(offsetof(URestartClient_C, UberGraphFrame) == 0x000530, "Member 'URestartClient_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(URestartClient_C, Intro) == 0x000538, "Member 'URestartClient_C::Intro' has a wrong offset!");
static_assert(offsetof(URestartClient_C, Button_Confirm) == 0x000540, "Member 'URestartClient_C::Button_Confirm' has a wrong offset!");
