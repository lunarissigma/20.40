...
// 0x0000 (0x0538 - 0x0538)
class UFootstepFoley final : public UFortSoundCueTemplateBase
{
public:
	static class UClass* StaticClass()
	{
...
// Class FortSoundCueTemplates.FootstepSCTDefaults
// 0x0128 (0x0210 - 0x00E8)
class UFootstepSCTDefaults final : public UFortSoundCueTemplateDefaults
{
public:
	TSoftObjectPtr<class USoundClass>             LocalPlayerSoundClass;                             // 0x00E8(0x0028)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class USoundClass>             TeammateSoundClass;                                // 0x0110(0x0028)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"FootstepSCTDefaults">();
	}
	static class UFootstepSCTDefaults* GetDefaultObj()
	{
		return GetDefaultObjImpl<UFootstepSCTDefaults>();
	}
};
static_assert(alignof(UFootstepSCTDefaults) == 0x000008, "Wrong alignment on UFootstepSCTDefaults");
static_assert(sizeof(UFootstepSCTDefaults) == 0x000210, "Wrong size on UFootstepSCTDefaults");
static_assert(offsetof(UFootstepSCTDefaults, LocalPlayerSoundClass) == 0x0000E8, "Member 'UFootstepSCTDefaults::LocalPlayerSoundClass' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, TeammateSoundClass) == 0x000110, "Member 'UFootstepSCTDefaults::TeammateSoundClass' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, HostileSoundClass) == 0x000138, "Member 'UFootstepSCTDefaults::HostileSoundClass' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, LocalPlayerAttenuation) == 0x000160, "Member 'UFootstepSCTDefaults::LocalPlayerAttenuation' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, AboveAttenuation) == 0x000188, "Member 'UFootstepSCTDefaults::AboveAttenuation' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, BelowAttenuation) == 0x0001B0, "Member 'UFootstepSCTDefaults::BelowAttenuation' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, ParallelAttenuation) == 0x0001D8, "Member 'UFootstepSCTDefaults::ParallelAttenuation' has a wrong offset!");
static_assert(offsetof(UFootstepSCTDefaults, ElevationCrossfadeDistances) == 0x000200, "Member 'UFootstepSCTDefaults::ElevationCrossfadeDistances' has a wrong offset!");
...
// 0x0000 (0x0538 - 0x0538)
class UPlayerFoley final : public UPlayerFoleyBase
{
public:
	static class UClass* StaticClass()
	{
