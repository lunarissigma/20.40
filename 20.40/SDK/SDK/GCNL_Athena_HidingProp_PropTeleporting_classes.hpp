...
static_assert(sizeof(AGCNL_Athena_HidingProp_PropTeleporting_C) == 0x000950, "Wrong size on AGCNL_Athena_HidingProp_PropTeleporting_C");
static_assert(offsetof(AGCNL_Athena_HidingProp_PropTeleporting_C, UberGraphFrame) == 0x000948, "Member 'AGCNL_Athena_HidingProp_PropTeleporting_C::UberGraphFrame' has a wrong offset!");
