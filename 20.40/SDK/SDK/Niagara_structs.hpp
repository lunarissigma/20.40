...
{
public:
	struct FMovieSceneFloatChannel                FloatChannel;                                      // 0x0038(0x00E8)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieSceneNiagaraFloatParameterSectionTemplate) == 0x000120, "Wrong size on FMovieSceneNiagaraFloatParameterSectionTemplate");
...
{
public:
	struct FMovieSceneBoolChannel                 BoolChannel;                                       // 0x0038(0x00D8)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieSceneNiagaraBoolParameterSectionTemplate) == 0x000110, "Wrong size on FMovieSceneNiagaraBoolParameterSectionTemplate");
...
{
public:
	struct FMovieSceneFloatChannel                RedChannel;                                        // 0x0038(0x00E8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                GreenChannel;                                      // 0x0120(0x00E8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                BlueChannel;                                       // 0x0208(0x00E8)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                AlphaChannel;                                      // 0x02F0(0x00E8)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieSceneNiagaraColorParameterSectionTemplate) == 0x0003D8, "Wrong size on FMovieSceneNiagaraColorParameterSectionTemplate");
...
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, GreenChannel) == 0x000120, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::GreenChannel' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, BlueChannel) == 0x000208, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::BlueChannel' has a wrong offset!");
static_assert(offsetof(FMovieSceneNiagaraColorParameterSectionTemplate, AlphaChannel) == 0x0002F0, "Member 'FMovieSceneNiagaraColorParameterSectionTemplate::AlphaChannel' has a wrong offset!");
...
{
public:
	struct FMovieSceneIntegerChannel              IntegerChannel;                                    // 0x0038(0x00D8)(NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FMovieSceneNiagaraIntegerParameterSectionTemplate) == 0x000110, "Wrong size on FMovieSceneNiagaraIntegerParameterSectionTemplate");
...
public:
	...
	ENiagaraDebugHUDPerfSampleMode                PerfSampleMode;                                    // 0x0110(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ENiagaraDebugHUDPerfGraphMode                 PerfGraphMode;                                     // 0x0114(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	ENiagaraDebugPlaybackMode                     PlaybackMode;                                      // 0x0210(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FNiagaraDebugHUDSettingsData) == 0x000228, "Wrong size on FNiagaraDebugHUDSettingsData");
...
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowBounds) == 0x00008C, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowBounds' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bSystemShowActiveOnlyInWorld) == 0x00008D, "Member 'FNiagaraDebugHUDSettingsData::bSystemShowActiveOnlyInWorld' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowSystemVariables) == 0x00008E, "Member 'FNiagaraDebugHUDSettingsData::bShowSystemVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemVariables) == 0x000090, "Member 'FNiagaraDebugHUDSettingsData::SystemVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemTextOptions) == 0x0000A0, "Member 'FNiagaraDebugHUDSettingsData::SystemTextOptions' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleVariables) == 0x0000B8, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableGpuParticleReadback) == 0x0000B9, "Member 'FNiagaraDebugHUDSettingsData::bEnableGpuParticleReadback' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticlesVariables) == 0x0000C0, "Member 'FNiagaraDebugHUDSettingsData::ParticlesVariables' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleTextOptions) == 0x0000D0, "Member 'FNiagaraDebugHUDSettingsData::ParticleTextOptions' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticlesVariablesWithSystem) == 0x0000E8, "Member 'FNiagaraDebugHUDSettingsData::bShowParticlesVariablesWithSystem' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowParticleVariablesVertical) == 0x0000E9, "Member 'FNiagaraDebugHUDSettingsData::bShowParticleVariablesVertical' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseMaxParticlesToDisplay) == 0x0000EA, "Member 'FNiagaraDebugHUDSettingsData::bUseMaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayClip) == 0x0000EB, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayClip) == 0x0000F0, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayClip' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bUseParticleDisplayCenterRadius) == 0x000100, "Member 'FNiagaraDebugHUDSettingsData::bUseParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, ParticleDisplayCenterRadius) == 0x000104, "Member 'FNiagaraDebugHUDSettingsData::ParticleDisplayCenterRadius' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MaxParticlesToDisplay) == 0x000108, "Member 'FNiagaraDebugHUDSettingsData::MaxParticlesToDisplay' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfReportFrames) == 0x00010C, "Member 'FNiagaraDebugHUDSettingsData::PerfReportFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfSampleMode) == 0x000110, "Member 'FNiagaraDebugHUDSettingsData::PerfSampleMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphMode) == 0x000114, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfHistoryFrames) == 0x000118, "Member 'FNiagaraDebugHUDSettingsData::PerfHistoryFrames' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphTimeRange) == 0x00011C, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphTimeRange' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphSize) == 0x000120, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphSize' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PerfGraphAxisColor) == 0x000130, "Member 'FNiagaraDebugHUDSettingsData::PerfGraphAxisColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bEnableSmoothing) == 0x000140, "Member 'FNiagaraDebugHUDSettingsData::bEnableSmoothing' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SmoothingWidth) == 0x000144, "Member 'FNiagaraDebugHUDSettingsData::SmoothingWidth' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, DefaultBackgroundColor) == 0x000148, "Member 'FNiagaraDebugHUDSettingsData::DefaultBackgroundColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewHeadingColor) == 0x000158, "Member 'FNiagaraDebugHUDSettingsData::OverviewHeadingColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailColor) == 0x000168, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, OverviewDetailHighlightColor) == 0x000178, "Member 'FNiagaraDebugHUDSettingsData::OverviewDetailHighlightColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldErrorTextColor) == 0x000188, "Member 'FNiagaraDebugHUDSettingsData::InWorldErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, InWorldTextColor) == 0x000198, "Member 'FNiagaraDebugHUDSettingsData::InWorldTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageInfoTextColor) == 0x0001A8, "Member 'FNiagaraDebugHUDSettingsData::MessageInfoTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageWarningTextColor) == 0x0001B8, "Member 'FNiagaraDebugHUDSettingsData::MessageWarningTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, MessageErrorTextColor) == 0x0001C8, "Member 'FNiagaraDebugHUDSettingsData::MessageErrorTextColor' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorTableOpacity) == 0x0001D8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorTableOpacity' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorSeed) == 0x0001DC, "Member 'FNiagaraDebugHUDSettingsData::SystemColorSeed' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMin) == 0x0001E0, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMin' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, SystemColorHSVMax) == 0x0001F8, "Member 'FNiagaraDebugHUDSettingsData::SystemColorHSVMax' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackMode) == 0x000210, "Member 'FNiagaraDebugHUDSettingsData::PlaybackMode' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bPlaybackRateEnabled) == 0x000211, "Member 'FNiagaraDebugHUDSettingsData::bPlaybackRateEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, PlaybackRate) == 0x000214, "Member 'FNiagaraDebugHUDSettingsData::PlaybackRate' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bLoopTimeEnabled) == 0x000218, "Member 'FNiagaraDebugHUDSettingsData::bLoopTimeEnabled' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, LoopTime) == 0x00021C, "Member 'FNiagaraDebugHUDSettingsData::LoopTime' has a wrong offset!");
static_assert(offsetof(FNiagaraDebugHUDSettingsData, bShowGlobalBudgetInfo) == 0x000220, "Member 'FNiagaraDebugHUDSettingsData::bShowGlobalBudgetInfo' has a wrong offset!");
...
{
public:
	struct FMovieSceneFloatChannel                VectorChannels[0x4];                               // 0x0038(0x00E8)(NativeAccessSpecifierPrivate)
	int32                                         ChannelsUsed;                                      // 0x03D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMovieSceneNiagaraVectorParameterSectionTemplate) == 0x0003E0, "Wrong size on FMovieSceneNiagaraVectorParameterSectionTemplate");
...
static_assert(offsetof(FMovieSceneNiagaraVectorParameterSectionTemplate, ChannelsUsed) == 0x0003D8, "Member 'FMovieSceneNiagaraVectorParameterSectionTemplate::ChannelsUsed' has a wrong offset!");
...
{
public:
	class FName                                   SourceName;                                        // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraBakerTextureSource) == 0x000004, "Wrong alignment on FNiagaraBakerTextureSource");
static_assert(sizeof(FNiagaraBakerTextureSource) == 0x000004, "Wrong size on FNiagaraBakerTextureSource");
...
public:
	...
	struct FNiagaraBakerTextureSource             SourceBinding;                                     // 0x0004(0x0004)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FNiagaraBakerTextureSettings, SourceBinding) == 0x000004, "Member 'FNiagaraBakerTextureSettings::SourceBinding' has a wrong offset!");
...
public:
	...
	struct FNiagaraVariable                       WritableValue;                                     // 0x00B0(0x0018)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FNiagaraComponentPropertyBinding, WritableValue) == 0x0000B0, "Member 'FNiagaraComponentPropertyBinding::WritableValue' has a wrong offset!");
...
public:
	...
	ENCPoolMethod                                 PoolMethod;                                        // 0x0038(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FNiagaraOutlinerTimingData             AverageTime;                                       // 0x003C(0x0008)(Edit, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	struct FNiagaraOutlinerTimingData             MaxTime;                                           // 0x0044(0x0008)(Edit, EditConst, NoDestructor, NativeAccessSpecifierPublic)
	ETickingGroup                                 TickGroup;                                         // 0x004C(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4D[0x3];                                       // 0x004D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bIsSolo : 1;                                       // 0x0050(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresDistanceFieldData : 1;                    // 0x0050(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresDepthBuffer : 1;                          // 0x0050(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresEarlyViewData : 1;                        // 0x0050(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresViewUniformBuffer : 1;                    // 0x0050(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRequiresRayTracingScene : 1;                      // 0x0050(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FNiagaraOutlinerSystemInstanceData) == 0x000058, "Wrong size on FNiagaraOutlinerSystemInstanceData");
...
static_assert(offsetof(FNiagaraOutlinerSystemInstanceData, PoolMethod) == 0x000038, "Member 'FNiagaraOutlinerSystemInstanceData::PoolMethod' has a wrong offset!");
static_assert(offsetof(FNiagaraOutlinerSystemInstanceData, AverageTime) == 0x00003C, "Member 'FNiagaraOutlinerSystemInstanceData::AverageTime' has a wrong offset!");
static_assert(offsetof(FNiagaraOutlinerSystemInstanceData, MaxTime) == 0x000044, "Member 'FNiagaraOutlinerSystemInstanceData::MaxTime' has a wrong offset!");
static_assert(offsetof(FNiagaraOutlinerSystemInstanceData, TickGroup) == 0x00004C, "Member 'FNiagaraOutlinerSystemInstanceData::TickGroup' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraEmitter*                        Instance;                                          // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FNiagaraEmitterHandle) == 0x000008, "Wrong alignment on FNiagaraEmitterHandle");
static_assert(sizeof(FNiagaraEmitterHandle) == 0x000028, "Wrong size on FNiagaraEmitterHandle");
...
public:
	...
	ENiagaraMeshPivotOffsetSpace                  PivotOffsetSpace;                                  // 0x0050(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNiagaraMeshRendererMeshProperties) == 0x000008, "Wrong alignment on FNiagaraMeshRendererMeshProperties");
static_assert(sizeof(FNiagaraMeshRendererMeshProperties) == 0x000058, "Wrong size on FNiagaraMeshRendererMeshProperties");
...
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, PivotOffset) == 0x000038, "Member 'FNiagaraMeshRendererMeshProperties::PivotOffset' has a wrong offset!");
static_assert(offsetof(FNiagaraMeshRendererMeshProperties, PivotOffsetSpace) == 0x000050, "Member 'FNiagaraMeshRendererMeshProperties::PivotOffsetSpace' has a wrong offset!");
...
static_assert(alignof(FNiagaraRibbonShapeCustomVertex) == 0x000008, "Wrong alignment on FNiagaraRibbonShapeCustomVertex");
static_assert(sizeof(FNiagaraRibbonShapeCustomVertex) == 0x000028, "Wrong size on FNiagaraRibbonShapeCustomVertex");
...
static_assert(offsetof(FNiagaraRibbonShapeCustomVertex, Normal) == 0x000010, "Member 'FNiagaraRibbonShapeCustomVertex::Normal' has a wrong offset!");
static_assert(offsetof(FNiagaraRibbonShapeCustomVertex, TextureV) == 0x000020, "Member 'FNiagaraRibbonShapeCustomVertex::TextureV' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScalabilityManager) == 0x0000D0, "Wrong size on FNiagaraScalabilityManager");
...
public:
	...
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   Description;                                       // 0x0008(0x0018)(Edit, AssetRegistrySearchable, NativeAccessSpecifierPublic)
};
static_assert(alignof(FNiagaraModuleDependency) == 0x000008, "Wrong alignment on FNiagaraModuleDependency");
static_assert(sizeof(FNiagaraModuleDependency) == 0x000020, "Wrong size on FNiagaraModuleDependency");
...
static_assert(offsetof(FNiagaraModuleDependency, Description) == 0x000008, "Member 'FNiagaraModuleDependency::Description' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x000130, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, VariableGuid) == 0x000114, "Member 'FNiagaraVariableMetaData::VariableGuid' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x000124, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x000128, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
