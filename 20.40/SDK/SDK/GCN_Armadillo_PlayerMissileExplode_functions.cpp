...
#include "GCN_Armadillo_PlayerMissileExplode_classes.hpp"
#include "GCN_Armadillo_PlayerMissileExplode_parameters.hpp"
...
void UGCN_Armadillo_PlayerMissileExplode_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Armadillo_PlayerMissileExplode_C", "OnBurstGeneric");

	Params::GCN_Armadillo_PlayerMissileExplode_C_OnBurstGeneric Parms{};
