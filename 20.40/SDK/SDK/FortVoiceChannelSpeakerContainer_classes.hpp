...
{
public:
	class UFortMobileImage*                       SpeakerIcon;                                       // 0x0340(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UFortVoiceChannelSpeakerContainer_C) == 0x000350, "Wrong size on UFortVoiceChannelSpeakerContainer_C");
static_assert(offsetof(UFortVoiceChannelSpeakerContainer_C, SpeakerIcon) == 0x000340, "Member 'UFortVoiceChannelSpeakerContainer_C::SpeakerIcon' has a wrong offset!");
