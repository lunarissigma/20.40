...
public:
	...
	class AFortInventory*                         Inventory;                                         // 0x0948(0x0008)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_950[0x18];                                     // 0x0950(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	class USphereComponent*                       SphereComponent_InteractionRange;                  // 0x0968(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftClassPtr<class UClass>                   MenuWidget;                                        // 0x0970(0x0028)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWidgetComponent*                       WidgetComponent_PotContents;                       // 0x0998(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ACraftingObjectBGA) == 0x0009A0, "Wrong size on ACraftingObjectBGA");
static_assert(offsetof(ACraftingObjectBGA, Inventory) == 0x000948, "Member 'ACraftingObjectBGA::Inventory' has a wrong offset!");
static_assert(offsetof(ACraftingObjectBGA, SphereComponent_InteractionRange) == 0x000968, "Member 'ACraftingObjectBGA::SphereComponent_InteractionRange' has a wrong offset!");
static_assert(offsetof(ACraftingObjectBGA, MenuWidget) == 0x000970, "Member 'ACraftingObjectBGA::MenuWidget' has a wrong offset!");
static_assert(offsetof(ACraftingObjectBGA, WidgetComponent_PotContents) == 0x000998, "Member 'ACraftingObjectBGA::WidgetComponent_PotContents' has a wrong offset!");
