...
public:
	...
	TArray<struct FControlRigComponentMappedElement> MappedElements;                                 // 0x0598(0x0010)(Edit, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	bool                                          bResetInitialsBeforeSetup;                         // 0x05B9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UControlRig*                            ControlRig;                                        // 0x05C0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UControlRigComponent) == 0x000670, "Wrong size on UControlRigComponent");
...
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeSetup) == 0x0005B9, "Member 'UControlRigComponent::bResetInitialsBeforeSetup' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_130[0xC8];                                     // 0x0130(0x00C8)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigHierarchy) == 0x000220, "Wrong size on URigHierarchy");
