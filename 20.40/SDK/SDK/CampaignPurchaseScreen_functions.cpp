...
// Parameters:
// class UFortMtxStoreRootBase*            StoreScreen                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCampaignPurchaseScreen_C::OnStoreScreenCreated(class UFortMtxStoreRootBase* StoreScreen)
{
	static class UFunction* Func = nullptr;
