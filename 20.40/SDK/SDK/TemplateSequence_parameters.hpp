...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0770)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x000780, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x000780, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache) == 0x0006B0, "Wrong size on SequenceCameraShakeTestUtil_GetPostProcessBlendCache");
...
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, OutPPBlendWeight) == 0x0006A0, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::OutPPBlendWeight' has a wrong offset!");
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, ReturnValue) == 0x0006A4, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::ReturnValue' has a wrong offset!");
