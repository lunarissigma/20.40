...
static_assert(sizeof(UTabHUDOptions_New_C) == 0x000408, "Wrong size on UTabHUDOptions_New_C");
static_assert(offsetof(UTabHUDOptions_New_C, UberGraphFrame) == 0x000400, "Member 'UTabHUDOptions_New_C::UberGraphFrame' has a wrong offset!");
