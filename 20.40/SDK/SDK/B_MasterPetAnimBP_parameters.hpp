...
static_assert(sizeof(B_MasterPetAnimBP_C_PetSkeletalControlLayer) == 0x000048, "Wrong size on B_MasterPetAnimBP_C_PetSkeletalControlLayer");
...
static_assert(offsetof(B_MasterPetAnimBP_C_PetSkeletalControlLayer, HandIKAlphaOverride_0) == 0x000034, "Member 'B_MasterPetAnimBP_C_PetSkeletalControlLayer::HandIKAlphaOverride_0' has a wrong offset!");
static_assert(offsetof(B_MasterPetAnimBP_C_PetSkeletalControlLayer, PetSkeletalControlLayer_0) == 0x000038, "Member 'B_MasterPetAnimBP_C_PetSkeletalControlLayer::PetSkeletalControlLayer_0' has a wrong offset!");
