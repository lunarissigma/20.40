...
static_assert(sizeof(UAthenaTemperature_C) == 0x0002B8, "Wrong size on UAthenaTemperature_C");
static_assert(offsetof(UAthenaTemperature_C, UberGraphFrame) == 0x0002B0, "Member 'UAthenaTemperature_C::UberGraphFrame' has a wrong offset!");
