...
static_assert(sizeof(ABP_CameraLens_CrackExit_C) == 0x000370, "Wrong size on ABP_CameraLens_CrackExit_C");
static_assert(offsetof(ABP_CameraLens_CrackExit_C, Portal) == 0x000360, "Member 'ABP_CameraLens_CrackExit_C::Portal' has a wrong offset!");
