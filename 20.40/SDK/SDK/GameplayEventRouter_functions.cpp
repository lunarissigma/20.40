...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FGameplayEventListenerHandle&HandleToRemove                                         (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGameplayEventRouterComponent::StopListeningToEvent(const struct FGameplayEventListenerHandle& HandleToRemove)
{
	static class UFunction* Func = nullptr;
