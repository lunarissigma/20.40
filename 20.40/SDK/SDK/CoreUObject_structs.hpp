...
static_assert(sizeof(FAssetData) == 0x000048, "Wrong size on FAssetData");
static_assert(offsetof(FAssetData, ObjectPath) == 0x000000, "Member 'FAssetData::ObjectPath' has a wrong offset!");
static_assert(offsetof(FAssetData, PackageName) == 0x000004, "Member 'FAssetData::PackageName' has a wrong offset!");
static_assert(offsetof(FAssetData, PackagePath) == 0x000008, "Member 'FAssetData::PackagePath' has a wrong offset!");
static_assert(offsetof(FAssetData, AssetName) == 0x00000C, "Member 'FAssetData::AssetName' has a wrong offset!");
static_assert(offsetof(FAssetData, AssetClass) == 0x000010, "Member 'FAssetData::AssetClass' has a wrong offset!");
