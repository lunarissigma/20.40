...
public:
	...
	TWeakObjectPtr<class USceneComponent>         Component;                                         // 0x0060(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   BoneName;                                          // 0x0068(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFollowComponent;                                  // 0x006C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D[0x3];                                       // 0x006D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMotionWarpingTarget) == 0x000010, "Wrong alignment on FMotionWarpingTarget");
static_assert(sizeof(FMotionWarpingTarget) == 0x000070, "Wrong size on FMotionWarpingTarget");
static_assert(offsetof(FMotionWarpingTarget, Transform) == 0x000000, "Member 'FMotionWarpingTarget::Transform' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, Component) == 0x000060, "Member 'FMotionWarpingTarget::Component' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, BoneName) == 0x000068, "Member 'FMotionWarpingTarget::BoneName' has a wrong offset!");
static_assert(offsetof(FMotionWarpingTarget, bFollowComponent) == 0x00006C, "Member 'FMotionWarpingTarget::bFollowComponent' has a wrong offset!");
