...
void UAthenaLockerTab_C::BeginPickingCustomization(class UCommonButtonLegacy* WidgetToReturnFocusTo, const struct FAthenaCustomizationParams& CustomizationParams_0)
{
	static class UFunction* Func = nullptr;
