...
public:
	...
	class UAudioComponent*                        AttachSoundAudioComp;                              // 0x0A30(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<bool>                                  NewVar_0;                                          // 0x0A38(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(AGCNL_Zipline_Travel_C) == 0x000A48, "Wrong size on AGCNL_Zipline_Travel_C");
static_assert(offsetof(AGCNL_Zipline_Travel_C, UberGraphFrame) == 0x000A28, "Member 'AGCNL_Zipline_Travel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_Zipline_Travel_C, AttachSoundAudioComp) == 0x000A30, "Member 'AGCNL_Zipline_Travel_C::AttachSoundAudioComp' has a wrong offset!");
static_assert(offsetof(AGCNL_Zipline_Travel_C, NewVar_0) == 0x000A38, "Member 'AGCNL_Zipline_Travel_C::NewVar_0' has a wrong offset!");
