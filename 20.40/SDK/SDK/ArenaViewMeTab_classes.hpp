...
static_assert(sizeof(UArenaViewMeTab_C) == 0x0003C8, "Wrong size on UArenaViewMeTab_C");
static_assert(offsetof(UArenaViewMeTab_C, UberGraphFrame) == 0x0003C0, "Member 'UArenaViewMeTab_C::UberGraphFrame' has a wrong offset!");
