...
{
public:
	struct FGameplayTagContainer                  CooldownTagsToListenTo;                            // 0x0AB8(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  CombinedCooldownTags;                              // 0x0AD8(0x0020)(Edit, EditConst, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleEliminationAbility) == 0x000AF8, "Wrong size on UMoleEliminationAbility");
static_assert(offsetof(UMoleEliminationAbility, CooldownTagsToListenTo) == 0x000AB8, "Member 'UMoleEliminationAbility::CooldownTagsToListenTo' has a wrong offset!");
static_assert(offsetof(UMoleEliminationAbility, CombinedCooldownTags) == 0x000AD8, "Member 'UMoleEliminationAbility::CombinedCooldownTags' has a wrong offset!");
...
{
public:
	class APlayerState*                           RepresentedPlayer;                                 // 0x0940(0x0008)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMoleEliminationMarker) == 0x000948, "Wrong size on AMoleEliminationMarker");
static_assert(offsetof(AMoleEliminationMarker, RepresentedPlayer) == 0x000940, "Member 'AMoleEliminationMarker::RepresentedPlayer' has a wrong offset!");
...
{
public:
	class UTargetingPreset*                       VotingTargetingPreset;                             // 0x0AB8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FTargetingRequestHandle                AsyncTargetingHandle;                              // 0x0AC0(0x0004)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_AC4[0x4];                                      // 0x0AC4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 BestVotingTarget;                                  // 0x0AC8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleGameplayAbility_Voting) == 0x000AD0, "Wrong size on UMoleGameplayAbility_Voting");
static_assert(offsetof(UMoleGameplayAbility_Voting, VotingTargetingPreset) == 0x000AB8, "Member 'UMoleGameplayAbility_Voting::VotingTargetingPreset' has a wrong offset!");
static_assert(offsetof(UMoleGameplayAbility_Voting, AsyncTargetingHandle) == 0x000AC0, "Member 'UMoleGameplayAbility_Voting::AsyncTargetingHandle' has a wrong offset!");
static_assert(offsetof(UMoleGameplayAbility_Voting, BestVotingTarget) == 0x000AC8, "Member 'UMoleGameplayAbility_Voting::BestVotingTarget' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           SabotageTag;                                       // 0x0AB8(0x0004)(Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_ABC[0x4];                                      // 0x0ABC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  CooldownTagsToListenTo;                            // 0x0AC0(0x0020)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  CombinedCooldownTags;                              // 0x0AE0(0x0020)(Edit, EditConst, Protected, NativeAccessSpecifierProtected)
	EMoleSabotageInterruptionType                 InterruptionType;                                  // 0x0B00(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_B01[0x3];                                      // 0x0B01(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEventMessageTag                       SabotageEventMessageTag;                           // 0x0B04(0x0004)(Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleSabotageAbility) == 0x000B08, "Wrong size on UMoleSabotageAbility");
static_assert(offsetof(UMoleSabotageAbility, SabotageTag) == 0x000AB8, "Member 'UMoleSabotageAbility::SabotageTag' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, CooldownTagsToListenTo) == 0x000AC0, "Member 'UMoleSabotageAbility::CooldownTagsToListenTo' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, CombinedCooldownTags) == 0x000AE0, "Member 'UMoleSabotageAbility::CombinedCooldownTags' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, InterruptionType) == 0x000B00, "Member 'UMoleSabotageAbility::InterruptionType' has a wrong offset!");
static_assert(offsetof(UMoleSabotageAbility, SabotageEventMessageTag) == 0x000B04, "Member 'UMoleSabotageAbility::SabotageEventMessageTag' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         NumberOfPointsToFix;                               // 0x0B10(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
	TArray<struct FMoleActiveTaskStateHandle>     FixTaskHandles;                                    // 0x0B38(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	class FName                                   InteractionInfoRowName;                            // 0x0B48(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_B4C[0x4];                                      // 0x0B4C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMoleTaskLinkComponent*>         ChosenFixPoints;                                   // 0x0B50(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleSupplyDropSabotageAbility) == 0x000B60, "Wrong size on UMoleSupplyDropSabotageAbility");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, NumberOfPointsToFix) == 0x000B10, "Member 'UMoleSupplyDropSabotageAbility::NumberOfPointsToFix' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, FixTaskHandles) == 0x000B38, "Member 'UMoleSupplyDropSabotageAbility::FixTaskHandles' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, InteractionInfoRowName) == 0x000B48, "Member 'UMoleSupplyDropSabotageAbility::InteractionInfoRowName' has a wrong offset!");
static_assert(offsetof(UMoleSupplyDropSabotageAbility, ChosenFixPoints) == 0x000B50, "Member 'UMoleSupplyDropSabotageAbility::ChosenFixPoints' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class UMoleTaskLinkComponent* TaskLinkComponent, const class AFortPawn* InteractingPawn, EInteractionBeingAttempted InteractionType)> OnTaskLinkOwnerActorInteract; // 0x00E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x0030 (0x0B38 - 0x0B08)
class UMoleTeleportAllSabotageAbility final : public UMoleSabotageAbility
{
public:
	struct FScalableFloat                         TimeBeforeTeleport;                                // 0x0B08(0x0028)(Edit, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleTeleportAllSabotageAbility) == 0x000B38, "Wrong size on UMoleTeleportAllSabotageAbility");
static_assert(offsetof(UMoleTeleportAllSabotageAbility, TimeBeforeTeleport) == 0x000B08, "Member 'UMoleTeleportAllSabotageAbility::TimeBeforeTeleport' has a wrong offset!");
...
static_assert(alignof(IMoleUIIndicatorManagerComponentInterface) == 0x000001, "Wrong alignment on IMoleUIIndicatorManagerComponentInterface");
static_assert(sizeof(IMoleUIIndicatorManagerComponentInterface) == 0x000001, "Wrong size on IMoleUIIndicatorManagerComponentInterface");
