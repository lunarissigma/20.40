...
{
public:
	TMap<int32, TSoftObjectPtr<class UAnimBlueprint>> AnimSlotToBP;                                  // 0x0000(0x0050)(Edit, EditFixedSize, Transient, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
};
