...
static_assert(offsetof(ULiveLinkComponentController, ComponentToControl) == 0x000118, "Member 'ULiveLinkComponentController::ComponentToControl' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bDisableEvaluateLiveLinkWhenSpawnable) == 0x000140, "Member 'ULiveLinkComponentController::bDisableEvaluateLiveLinkWhenSpawnable' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bEvaluateLiveLink) == 0x000141, "Member 'ULiveLinkComponentController::bEvaluateLiveLink' has a wrong offset!");
static_assert(offsetof(ULiveLinkComponentController, bUpdateInPreviewEditor) == 0x000142, "Member 'ULiveLinkComponentController::bUpdateInPreviewEditor' has a wrong offset!");
