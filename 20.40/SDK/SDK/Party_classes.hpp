...
public:
	...
	class APartyBeaconClient*                     ReservationBeaconClient;                           // 0x01F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(USocialParty) == 0x000340, "Wrong size on USocialParty");
...
static_assert(offsetof(USocialParty, PlatformUserInviteCooldown) == 0x000178, "Member 'USocialParty::PlatformUserInviteCooldown' has a wrong offset!");
static_assert(offsetof(USocialParty, PrimaryUserInviteCooldown) == 0x000180, "Member 'USocialParty::PrimaryUserInviteCooldown' has a wrong offset!");
static_assert(offsetof(USocialParty, ReservationBeaconClient) == 0x0001F8, "Member 'USocialParty::ReservationBeaconClient' has a wrong offset!");
static_assert(offsetof(USocialParty, SpectatorBeaconClient) == 0x000208, "Member 'USocialParty::SpectatorBeaconClient' has a wrong offset!");
