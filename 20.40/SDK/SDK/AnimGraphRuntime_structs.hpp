...
static_assert(sizeof(FAnimNode_RigidBody) == 0x000980, "Wrong size on FAnimNode_RigidBody");
...
static_assert(sizeof(FAnimNode_CopyPoseFromMesh) == 0x000180, "Wrong size on FAnimNode_CopyPoseFromMesh");
...
static_assert(offsetof(FAnimNode_Mirror_Standalone, BlendTimeOnMirrorStateChange) == 0x000058, "Member 'FAnimNode_Mirror_Standalone::BlendTimeOnMirrorStateChange' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror_Standalone, bBoneMirroring) == 0x00005C, "Member 'FAnimNode_Mirror_Standalone::bBoneMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror_Standalone, bCurveMirroring) == 0x00005D, "Member 'FAnimNode_Mirror_Standalone::bCurveMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror_Standalone, bAttributeMirroring) == 0x00005E, "Member 'FAnimNode_Mirror_Standalone::bAttributeMirroring' has a wrong offset!");
static_assert(offsetof(FAnimNode_Mirror_Standalone, bResetChildOnMirrorStateChange) == 0x00005F, "Member 'FAnimNode_Mirror_Standalone::bResetChildOnMirrorStateChange' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0000D4, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x000108, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000109, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
public:
	...
	class UAnimSequenceBase*                      Sequence;                                          // 0x0048(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                         Pad_948[0x308];                                    // 0x0948(0x0308)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000C50, "Wrong size on FAnimSequencerInstanceProxy");
