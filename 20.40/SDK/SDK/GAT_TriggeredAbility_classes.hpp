...
public:
	...
	struct FGameplayTag                           TC_AbilitiesGenericTriggeredAbilityActivate;       // 0x0AC0(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bPlayerHolsterState;                               // 0x0AC4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGAT_TriggeredAbility_C) == 0x000AC8, "Wrong size on UGAT_TriggeredAbility_C");
...
static_assert(offsetof(UGAT_TriggeredAbility_C, bPlayerHolsterState) == 0x000AC4, "Member 'UGAT_TriggeredAbility_C::bPlayerHolsterState' has a wrong offset!");
