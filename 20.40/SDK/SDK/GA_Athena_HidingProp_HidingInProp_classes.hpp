...
public:
	...
	struct FScalableFloat                         Row_bDisablePlayerCollision;                       // 0x0AE0(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UGA_Athena_HidingProp_HidingInProp_C) == 0x000B08, "Wrong size on UGA_Athena_HidingProp_HidingInProp_C");
...
static_assert(offsetof(UGA_Athena_HidingProp_HidingInProp_C, Row_bDisablePlayerCollision) == 0x000AE0, "Member 'UGA_Athena_HidingProp_HidingInProp_C::Row_bDisablePlayerCollision' has a wrong offset!");
