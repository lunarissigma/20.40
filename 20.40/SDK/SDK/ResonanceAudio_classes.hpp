...
public:
	...
	class UMaterial*                              Material;                                          // 0x02E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AResonanceAudioDirectivityVisualizer) == 0x0002F0, "Wrong size on AResonanceAudioDirectivityVisualizer");
static_assert(offsetof(AResonanceAudioDirectivityVisualizer, Material) == 0x0002E0, "Member 'AResonanceAudioDirectivityVisualizer::Material' has a wrong offset!");
static_assert(offsetof(AResonanceAudioDirectivityVisualizer, Settings) == 0x0002E8, "Member 'AResonanceAudioDirectivityVisualizer::Settings' has a wrong offset!");
