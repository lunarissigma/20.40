...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0) == 0x000240, "Wrong size on AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0");
...
static_assert(offsetof(AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0, ReturnValue) == 0x0000D0, "Member 'AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0::ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0, CallFunc_Handled_ReturnValue) == 0x000188, "Member 'AthenaLobbyPlayerPanel_C_OnMouseButtonDown_0::CallFunc_Handled_ReturnValue' has a wrong offset!");
