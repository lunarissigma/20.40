...
public:
	...
	TArray<class UAnimBlueprint*>                 GatheredAnimBPs;                                   // 0x0338(0x0010)(Edit, EditFixedSize, ZeroConstructor, Transient, EditConst, NativeAccessSpecifierPublic)
...
public:
	...
	TMap<class FString, TSoftObjectPtr<class UAnimBlueprint>> AnimBPAssetsMap;                       // 0x0258(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	class UAnimBlueprint* GetAnimBP(int32 ComponentIndex, int32 SlotIndex) const;
