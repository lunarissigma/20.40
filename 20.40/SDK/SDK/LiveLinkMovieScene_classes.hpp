...
public:
	...
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0130(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_140[0x10];                                     // 0x0140(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SubjectName;                                       // 0x0150(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x0000C8, "Wrong size on UMovieSceneLiveLinkTrack");
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x0000C0, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
