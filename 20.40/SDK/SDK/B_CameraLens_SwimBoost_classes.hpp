...
static_assert(sizeof(AB_CameraLens_SwimBoost_C) == 0x000370, "Wrong size on AB_CameraLens_SwimBoost_C");
static_assert(offsetof(AB_CameraLens_SwimBoost_C, UberGraphFrame) == 0x000360, "Member 'AB_CameraLens_SwimBoost_C::UberGraphFrame' has a wrong offset!");
