...
static_assert(alignof(IItemAnimLayerInterface_C) == 0x000001, "Wrong alignment on IItemAnimLayerInterface_C");
static_assert(sizeof(IItemAnimLayerInterface_C) == 0x000001, "Wrong size on IItemAnimLayerInterface_C");
