...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GAB_Melee_GenericCombo_C;           // 0x0AF0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	float                                         OriginalMontagePlayRate;                           // 0x0AF8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGAB_Melee_GenericCombo_C) == 0x000B00, "Wrong size on UGAB_Melee_GenericCombo_C");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, UberGraphFrame_GAB_Melee_GenericCombo_C) == 0x000AF0, "Member 'UGAB_Melee_GenericCombo_C::UberGraphFrame_GAB_Melee_GenericCombo_C' has a wrong offset!");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, OriginalMontagePlayRate) == 0x000AF8, "Member 'UGAB_Melee_GenericCombo_C::OriginalMontagePlayRate' has a wrong offset!");
