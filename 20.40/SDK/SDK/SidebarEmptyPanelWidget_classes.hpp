...
static_assert(sizeof(USidebarEmptyPanelWidget_C) == 0x001040, "Wrong size on USidebarEmptyPanelWidget_C");
static_assert(offsetof(USidebarEmptyPanelWidget_C, UberGraphFrame) == 0x001030, "Member 'USidebarEmptyPanelWidget_C::UberGraphFrame' has a wrong offset!");
