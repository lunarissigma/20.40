...
{
public:
	float                                         OverrideTransitionTime;                            // 0x11E0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_11E4[0xC];                                     // 0x11E4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFortCameraMode_SpecialEventFocalPoint) == 0x0011F0, "Wrong size on UFortCameraMode_SpecialEventFocalPoint");
static_assert(offsetof(UFortCameraMode_SpecialEventFocalPoint, OverrideTransitionTime) == 0x0011E0, "Member 'UFortCameraMode_SpecialEventFocalPoint::OverrideTransitionTime' has a wrong offset!");
...
static_assert(alignof(ISpecialEventCursorInstigatorInterface) == 0x000001, "Wrong alignment on ISpecialEventCursorInstigatorInterface");
static_assert(sizeof(ISpecialEventCursorInstigatorInterface) == 0x000001, "Wrong size on ISpecialEventCursorInstigatorInterface");
