...
static_assert(offsetof(URigVM, NumExecutions) == 0x000150, "Member 'URigVM::NumExecutions' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x000158, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Parameters) == 0x000188, "Member 'URigVM::Parameters' has a wrong offset!");
static_assert(offsetof(URigVM, ParametersNameMap) == 0x000198, "Member 'URigVM::ParametersNameMap' has a wrong offset!");
