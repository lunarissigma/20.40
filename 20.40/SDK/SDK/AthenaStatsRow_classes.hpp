...
static_assert(sizeof(UAthenaStatsRow_C) == 0x0002E0, "Wrong size on UAthenaStatsRow_C");
static_assert(offsetof(UAthenaStatsRow_C, UberGraphFrame) == 0x0002D8, "Member 'UAthenaStatsRow_C::UberGraphFrame' has a wrong offset!");
