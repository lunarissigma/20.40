...
public:
	...
	class UNiagaraComponent*                      NS_Loop_WorldFX_Persistent_Motes01;                // 0x0950(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      NS_Loop_WorldFX_Persistent;                        // 0x0958(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	struct FTimerHandle                           Timer;                                             // 0x0968(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	float                                         LoopingCheckTime;                                  // 0x0970(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AGCN_Loop_PlayerWorldPFX_Persistent_C) == 0x000978, "Wrong size on AGCN_Loop_PlayerWorldPFX_Persistent_C");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, UberGraphFrame) == 0x000948, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, NS_Loop_WorldFX_Persistent_Motes01) == 0x000950, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::NS_Loop_WorldFX_Persistent_Motes01' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, NS_Loop_WorldFX_Persistent) == 0x000958, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::NS_Loop_WorldFX_Persistent' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, My_Target) == 0x000960, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::My_Target' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, Timer) == 0x000968, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::Timer' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_PlayerWorldPFX_Persistent_C, LoopingCheckTime) == 0x000970, "Member 'AGCN_Loop_PlayerWorldPFX_Persistent_C::LoopingCheckTime' has a wrong offset!");
