...
{
public:
	TArray<struct FTankWeaponAimingData>          TankWeaponAimingData;                              // 0x0800(0x0010)(Edit, ZeroConstructor, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FText                                   SecondInteractText;                                // 0x0810(0x0018)(Edit, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	ETInteractionType                             SecondInteractType;                                // 0x0828(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_829[0x7];                                      // 0x0829(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         SecondInteractDuration;                            // 0x0830(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortTankVehicleConfigs) == 0x000858, "Wrong size on UFortTankVehicleConfigs");
static_assert(offsetof(UFortTankVehicleConfigs, TankWeaponAimingData) == 0x000800, "Member 'UFortTankVehicleConfigs::TankWeaponAimingData' has a wrong offset!");
static_assert(offsetof(UFortTankVehicleConfigs, SecondInteractText) == 0x000810, "Member 'UFortTankVehicleConfigs::SecondInteractText' has a wrong offset!");
static_assert(offsetof(UFortTankVehicleConfigs, SecondInteractType) == 0x000828, "Member 'UFortTankVehicleConfigs::SecondInteractType' has a wrong offset!");
static_assert(offsetof(UFortTankVehicleConfigs, SecondInteractDuration) == 0x000830, "Member 'UFortTankVehicleConfigs::SecondInteractDuration' has a wrong offset!");
...
// 0x0240 (0x1AD0 - 0x1890)
class AFortTankVehicle final : public AFortTreadVehicle
{
public:
	uint8                                         Pad_1890[0x78];                                    // 0x1890(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnTankRepairedDelegate;                            // 0x1908(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	class FName                                   BarrelSocketName;                                  // 0x1918(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_191C[0x4];                                     // 0x191C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCapsuleComponent*                      BarrelCollision;                                   // 0x1920(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UStaticMeshComponent*                   UnderVehicleCollision;                             // 0x1928(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FServerSocketTransformOverride> SocketOverrideArray;                               // 0x1930(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FTransform>          SocketTransformOverrideMap;                        // 0x1940(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	class USkeletalMeshComponent*                 CachedSkeletalMeshComponent;                       // 0x1990(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AFortVehicleAudioController*            CachedVehicleAudioController;                      // 0x1998(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EVisibilityBasedAnimTickOption                DefaultServerVisibilityBasedAnimTickOption;        // 0x19A0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          DefaultServerSkeletalMeshTickEnabled;              // 0x19A1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_19A2[0x2];                                     // 0x19A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   YawPivotSocketName;                                // 0x19A4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PitchPivotSocketName;                              // 0x19A8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_19AC[0x4];                                     // 0x19AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UMatineeCameraShake*                    DriverCameraShakeInstance;                         // 0x19B0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMatineeCameraShake*                    AcceleratingCameraShakeInstance;                   // 0x19B8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_19C0[0x8];                                     // 0x19C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraComponent*                      CachedNiagaraComponentRoadAndExhaust;              // 0x19C8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustNiagaraComponentName;                // 0x19D0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustPeelOutLeftName;                     // 0x19E0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustPeelOutRightName;                    // 0x19F0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustVehicleSpeedName;                    // 0x1A00(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustSlideDirectionName;                  // 0x1A10(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustMinSpeedForDust;                     // 0x1A20(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1A24[0x4];                                     // 0x1A24(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 RoadAndExhaustDustColorLerpName;                   // 0x1A28(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustColorLerpOffRoad;                // 0x1A38(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustColorLerpOnRoad;                 // 0x1A3C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustAlphaMultiplierName;             // 0x1A40(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustAlphaMultiplierOffRoad;          // 0x1A50(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         RoadAndExhaustDustAlphaMultiplierOnRoad;           // 0x1A54(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustFrontLeftName;                   // 0x1A58(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustFrontRightName;                  // 0x1A68(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustMiddleLeftName;                  // 0x1A78(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustMiddleRightName;                 // 0x1A88(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustRearLeftName;                    // 0x1A98(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustDustRearRightName;                   // 0x1AA8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 RoadAndExhaustIsOnDirtName;                        // 0x1AB8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AFortTankVehicle) == 0x001AD0, "Wrong size on AFortTankVehicle");
static_assert(offsetof(AFortTankVehicle, OnTankRepairedDelegate) == 0x001908, "Member 'AFortTankVehicle::OnTankRepairedDelegate' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, BarrelSocketName) == 0x001918, "Member 'AFortTankVehicle::BarrelSocketName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, BarrelCollision) == 0x001920, "Member 'AFortTankVehicle::BarrelCollision' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, UnderVehicleCollision) == 0x001928, "Member 'AFortTankVehicle::UnderVehicleCollision' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, SocketOverrideArray) == 0x001930, "Member 'AFortTankVehicle::SocketOverrideArray' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, SocketTransformOverrideMap) == 0x001940, "Member 'AFortTankVehicle::SocketTransformOverrideMap' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, CachedSkeletalMeshComponent) == 0x001990, "Member 'AFortTankVehicle::CachedSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, CachedVehicleAudioController) == 0x001998, "Member 'AFortTankVehicle::CachedVehicleAudioController' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, DefaultServerVisibilityBasedAnimTickOption) == 0x0019A0, "Member 'AFortTankVehicle::DefaultServerVisibilityBasedAnimTickOption' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, DefaultServerSkeletalMeshTickEnabled) == 0x0019A1, "Member 'AFortTankVehicle::DefaultServerSkeletalMeshTickEnabled' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, YawPivotSocketName) == 0x0019A4, "Member 'AFortTankVehicle::YawPivotSocketName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, PitchPivotSocketName) == 0x0019A8, "Member 'AFortTankVehicle::PitchPivotSocketName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, DriverCameraShakeInstance) == 0x0019B0, "Member 'AFortTankVehicle::DriverCameraShakeInstance' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, AcceleratingCameraShakeInstance) == 0x0019B8, "Member 'AFortTankVehicle::AcceleratingCameraShakeInstance' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, CachedNiagaraComponentRoadAndExhaust) == 0x0019C8, "Member 'AFortTankVehicle::CachedNiagaraComponentRoadAndExhaust' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustNiagaraComponentName) == 0x0019D0, "Member 'AFortTankVehicle::RoadAndExhaustNiagaraComponentName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustPeelOutLeftName) == 0x0019E0, "Member 'AFortTankVehicle::RoadAndExhaustPeelOutLeftName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustPeelOutRightName) == 0x0019F0, "Member 'AFortTankVehicle::RoadAndExhaustPeelOutRightName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustVehicleSpeedName) == 0x001A00, "Member 'AFortTankVehicle::RoadAndExhaustVehicleSpeedName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustSlideDirectionName) == 0x001A10, "Member 'AFortTankVehicle::RoadAndExhaustSlideDirectionName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustMinSpeedForDust) == 0x001A20, "Member 'AFortTankVehicle::RoadAndExhaustMinSpeedForDust' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustColorLerpName) == 0x001A28, "Member 'AFortTankVehicle::RoadAndExhaustDustColorLerpName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustColorLerpOffRoad) == 0x001A38, "Member 'AFortTankVehicle::RoadAndExhaustDustColorLerpOffRoad' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustColorLerpOnRoad) == 0x001A3C, "Member 'AFortTankVehicle::RoadAndExhaustDustColorLerpOnRoad' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustAlphaMultiplierName) == 0x001A40, "Member 'AFortTankVehicle::RoadAndExhaustDustAlphaMultiplierName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustAlphaMultiplierOffRoad) == 0x001A50, "Member 'AFortTankVehicle::RoadAndExhaustDustAlphaMultiplierOffRoad' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustAlphaMultiplierOnRoad) == 0x001A54, "Member 'AFortTankVehicle::RoadAndExhaustDustAlphaMultiplierOnRoad' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustFrontLeftName) == 0x001A58, "Member 'AFortTankVehicle::RoadAndExhaustDustFrontLeftName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustFrontRightName) == 0x001A68, "Member 'AFortTankVehicle::RoadAndExhaustDustFrontRightName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustMiddleLeftName) == 0x001A78, "Member 'AFortTankVehicle::RoadAndExhaustDustMiddleLeftName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustMiddleRightName) == 0x001A88, "Member 'AFortTankVehicle::RoadAndExhaustDustMiddleRightName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustRearLeftName) == 0x001A98, "Member 'AFortTankVehicle::RoadAndExhaustDustRearLeftName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustDustRearRightName) == 0x001AA8, "Member 'AFortTankVehicle::RoadAndExhaustDustRearRightName' has a wrong offset!");
static_assert(offsetof(AFortTankVehicle, RoadAndExhaustIsOnDirtName) == 0x001AB8, "Member 'AFortTankVehicle::RoadAndExhaustIsOnDirtName' has a wrong offset!");
