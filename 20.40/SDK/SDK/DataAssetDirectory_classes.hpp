...
static_assert(alignof(IDataAssetDirectoryPatchableAsset) == 0x000001, "Wrong alignment on IDataAssetDirectoryPatchableAsset");
static_assert(sizeof(IDataAssetDirectoryPatchableAsset) == 0x000001, "Wrong size on IDataAssetDirectoryPatchableAsset");
