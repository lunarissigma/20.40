...
{
public:
	class UMolePlayerTaskManagementComponent*     CachedOwningTaskComponent;                         // 0x0278(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleActiveTaskContextBarHUDWidget) == 0x000280, "Wrong size on UMoleActiveTaskContextBarHUDWidget");
static_assert(offsetof(UMoleActiveTaskContextBarHUDWidget, CachedOwningTaskComponent) == 0x000278, "Member 'UMoleActiveTaskContextBarHUDWidget::CachedOwningTaskComponent' has a wrong offset!");
...
{
public:
	class UDynamicEntryBox*                       TaskWidgetEntryBox;                                // 0x0278(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMolePlayerTaskManagementComponent*     CachedOwningTaskComponent;                         // 0x0280(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleAssignedTaskContainerWidget) == 0x000288, "Wrong size on UMoleAssignedTaskContainerWidget");
static_assert(offsetof(UMoleAssignedTaskContainerWidget, TaskWidgetEntryBox) == 0x000278, "Member 'UMoleAssignedTaskContainerWidget::TaskWidgetEntryBox' has a wrong offset!");
static_assert(offsetof(UMoleAssignedTaskContainerWidget, CachedOwningTaskComponent) == 0x000280, "Member 'UMoleAssignedTaskContainerWidget::CachedOwningTaskComponent' has a wrong offset!");
...
{
public:
	struct FKey                                   RepresentedKey;                                    // 0x0278(0x0018)(Edit, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortKeybindWidget*                     KeyBind_RepresentedAction;                         // 0x0290(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleControllerBinding) == 0x000298, "Wrong size on UMoleControllerBinding");
static_assert(offsetof(UMoleControllerBinding, RepresentedKey) == 0x000278, "Member 'UMoleControllerBinding::RepresentedKey' has a wrong offset!");
static_assert(offsetof(UMoleControllerBinding, KeyBind_RepresentedAction) == 0x000290, "Member 'UMoleControllerBinding::KeyBind_RepresentedAction' has a wrong offset!");
...
{
public:
	TMap<ECommonGamepadType, TSoftObjectPtr<class UObject>> ControllerImages;                        // 0x03F0(0x0050)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UCommonLazyImage*                       Image_Controller;                                  // 0x0440(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleControllerBindingsScreen) == 0x000448, "Wrong size on UMoleControllerBindingsScreen");
static_assert(offsetof(UMoleControllerBindingsScreen, ControllerImages) == 0x0003F0, "Member 'UMoleControllerBindingsScreen::ControllerImages' has a wrong offset!");
static_assert(offsetof(UMoleControllerBindingsScreen, Image_Controller) == 0x000440, "Member 'UMoleControllerBindingsScreen::Image_Controller' has a wrong offset!");
...
{
public:
	class UDataTable*                             AbilityUIDataTable;                                // 0x0278(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonListView*                        Listview_EnemyTasks;                               // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMoleEnemyAbilityWidgetComponent*       OwnerWidgetComponent;                              // 0x0288(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleEnemyAbilityContainer) == 0x000290, "Wrong size on UMoleEnemyAbilityContainer");
static_assert(offsetof(UMoleEnemyAbilityContainer, AbilityUIDataTable) == 0x000278, "Member 'UMoleEnemyAbilityContainer::AbilityUIDataTable' has a wrong offset!");
static_assert(offsetof(UMoleEnemyAbilityContainer, Listview_EnemyTasks) == 0x000280, "Member 'UMoleEnemyAbilityContainer::Listview_EnemyTasks' has a wrong offset!");
static_assert(offsetof(UMoleEnemyAbilityContainer, OwnerWidgetComponent) == 0x000288, "Member 'UMoleEnemyAbilityContainer::OwnerWidgetComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_F98[0x18];                                     // 0x0F98(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bIsInteractable;                                   // 0x0FB0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_FB1[0x7];                                      // 0x0FB1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMoleEnemyAbilityOverlay*               Overlay_EnemyAbilities;                            // 0x0FB8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleEnemyAbilityEntry) == 0x000FC0, "Wrong size on UMoleEnemyAbilityEntry");
static_assert(offsetof(UMoleEnemyAbilityEntry, bIsInteractable) == 0x000FB0, "Member 'UMoleEnemyAbilityEntry::bIsInteractable' has a wrong offset!");
static_assert(offsetof(UMoleEnemyAbilityEntry, Overlay_EnemyAbilities) == 0x000FB8, "Member 'UMoleEnemyAbilityEntry::Overlay_EnemyAbilities' has a wrong offset!");
...
public:
	...
	class UMoleEnemyAbilityItem*                  EnemyAbilityItem;                                  // 0x0288(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleEnemyAbilityOverlay) == 0x000298, "Wrong size on UMoleEnemyAbilityOverlay");
static_assert(offsetof(UMoleEnemyAbilityOverlay, EnemyAbilityItem) == 0x000288, "Member 'UMoleEnemyAbilityOverlay::EnemyAbilityItem' has a wrong offset!");
...
{
public:
	class UFortControllerComponent_MapDiscoverability* DiscoverabilityComponent;                     // 0x0278(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleLocationWidget) == 0x000280, "Wrong size on UMoleLocationWidget");
static_assert(offsetof(UMoleLocationWidget, DiscoverabilityComponent) == 0x000278, "Member 'UMoleLocationWidget::DiscoverabilityComponent' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            MolePlayerIcon;                                    // 0x0120(0x00C0)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FVector2D                              DesiredSize;                                       // 0x01E0(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                MapCenterOffset;                                   // 0x01F0(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          ShowMapBackground;                                 // 0x0208(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_209[0x3];                                      // 0x0209(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ZoomLevel;                                         // 0x020C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MinimapIndicatorZoomLevel;                         // 0x0210(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMoleMinimap) == 0x000220, "Wrong size on UMoleMinimap");
static_assert(offsetof(UMoleMinimap, MolePlayerIcon) == 0x000120, "Member 'UMoleMinimap::MolePlayerIcon' has a wrong offset!");
static_assert(offsetof(UMoleMinimap, DesiredSize) == 0x0001E0, "Member 'UMoleMinimap::DesiredSize' has a wrong offset!");
static_assert(offsetof(UMoleMinimap, MapCenterOffset) == 0x0001F0, "Member 'UMoleMinimap::MapCenterOffset' has a wrong offset!");
static_assert(offsetof(UMoleMinimap, ShowMapBackground) == 0x000208, "Member 'UMoleMinimap::ShowMapBackground' has a wrong offset!");
static_assert(offsetof(UMoleMinimap, ZoomLevel) == 0x00020C, "Member 'UMoleMinimap::ZoomLevel' has a wrong offset!");
static_assert(offsetof(UMoleMinimap, MinimapIndicatorZoomLevel) == 0x000210, "Member 'UMoleMinimap::MinimapIndicatorZoomLevel' has a wrong offset!");
...
static_assert(sizeof(UMoleMobileLoaderWidget) == 0x000298, "Wrong size on UMoleMobileLoaderWidget");
...
{
public:
	class UFortVoiceChatStatusIcon*               VoiceIcon_Status;                                  // 0x0278(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleNameplate) == 0x000280, "Wrong size on UMoleNameplate");
static_assert(offsetof(UMoleNameplate, VoiceIcon_Status) == 0x000278, "Member 'UMoleNameplate::VoiceIcon_Status' has a wrong offset!");
...
{
public:
	class UInputComponent*                        PostGameInputComponent;                            // 0x0278(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FMoleHoldBinding                       BackToMenuBinding;                                 // 0x0280(0x0018)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         MobileAutoGoBackToMenuTime;                        // 0x0298(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_29C[0x14];                                     // 0x029C(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	class UAthenaAccoladeListWidget*              Listview_Accolades;                                // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMolePostGameScreen) == 0x0002B8, "Wrong size on UMolePostGameScreen");
static_assert(offsetof(UMolePostGameScreen, PostGameInputComponent) == 0x000278, "Member 'UMolePostGameScreen::PostGameInputComponent' has a wrong offset!");
static_assert(offsetof(UMolePostGameScreen, BackToMenuBinding) == 0x000280, "Member 'UMolePostGameScreen::BackToMenuBinding' has a wrong offset!");
static_assert(offsetof(UMolePostGameScreen, MobileAutoGoBackToMenuTime) == 0x000298, "Member 'UMolePostGameScreen::MobileAutoGoBackToMenuTime' has a wrong offset!");
static_assert(offsetof(UMolePostGameScreen, Listview_Accolades) == 0x0002B0, "Member 'UMolePostGameScreen::Listview_Accolades' has a wrong offset!");
...
public:
	class UMolePlayerTaskManagementComponent*     CachedOwningTaskComponent;                         // 0x0278(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoleTaskHUDWidget*                     MoleTaskHUDWidget;                                 // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMolePrimaryActiveTaskHUDWidget) == 0x000288, "Wrong size on UMolePrimaryActiveTaskHUDWidget");
static_assert(offsetof(UMolePrimaryActiveTaskHUDWidget, CachedOwningTaskComponent) == 0x000278, "Member 'UMolePrimaryActiveTaskHUDWidget::CachedOwningTaskComponent' has a wrong offset!");
static_assert(offsetof(UMolePrimaryActiveTaskHUDWidget, MoleTaskHUDWidget) == 0x000280, "Member 'UMolePrimaryActiveTaskHUDWidget::MoleTaskHUDWidget' has a wrong offset!");
...
{
public:
	class FText                                   SelfMessageLogTitle;                               // 0x03B8(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   SelectedTokenFormat;                               // 0x03D0(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class UListView*                              ListView_MessageLog;                               // 0x03E8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMoleQuickChatMessageItem*>      MessageLog;                                        // 0x03F0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatLogWidget) == 0x000408, "Wrong size on UMoleQuickChatLogWidget");
static_assert(offsetof(UMoleQuickChatLogWidget, SelfMessageLogTitle) == 0x0003B8, "Member 'UMoleQuickChatLogWidget::SelfMessageLogTitle' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatLogWidget, SelectedTokenFormat) == 0x0003D0, "Member 'UMoleQuickChatLogWidget::SelectedTokenFormat' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatLogWidget, ListView_MessageLog) == 0x0003E8, "Member 'UMoleQuickChatLogWidget::ListView_MessageLog' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatLogWidget, MessageLog) == 0x0003F0, "Member 'UMoleQuickChatLogWidget::MessageLog' has a wrong offset!");
...
{
public:
	class UMoleQuickChatMapEntry*                 DefaultRoomWidgetToFocus;                          // 0x03B8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPanelWidget*                           Panel_Locations;                                   // 0x03C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonButtonBase*                      Button_SkipLocation;                               // 0x03C8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatMap) == 0x000418, "Wrong size on UMoleQuickChatMap");
static_assert(offsetof(UMoleQuickChatMap, DefaultRoomWidgetToFocus) == 0x0003B8, "Member 'UMoleQuickChatMap::DefaultRoomWidgetToFocus' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMap, Panel_Locations) == 0x0003C0, "Member 'UMoleQuickChatMap::Panel_Locations' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMap, Button_SkipLocation) == 0x0003C8, "Member 'UMoleQuickChatMap::Button_SkipLocation' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           LocationTag;                                       // 0x0F98(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F9C[0x3C];                                     // 0x0F9C(0x003C)(Fixing Size After Last Property [ Dumper-7 ])
	class UHorizontalBox*                         HBox_HerePin;                                      // 0x0FD8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatMapEntry) == 0x000FE0, "Wrong size on UMoleQuickChatMapEntry");
static_assert(offsetof(UMoleQuickChatMapEntry, LocationTag) == 0x000F98, "Member 'UMoleQuickChatMapEntry::LocationTag' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMapEntry, HBox_HerePin) == 0x000FD8, "Member 'UMoleQuickChatMapEntry::HBox_HerePin' has a wrong offset!");
...
{
public:
	class FName                                   PlayerPortraitColorAMaterialParameterName;         // 0x0F98(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   PlayerPortraitColorBMaterialParameterName;         // 0x0F9C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsOnLowerRow;                                     // 0x0FA0(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_FA1[0x7];                                      // 0x0FA1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerState*                           PlayerState;                                       // 0x0FA8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 PlayerName;                                        // 0x0FB0(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsLocalPlayer;                                    // 0x0FC0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsGhost;                                          // 0x0FC1(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsFilteredOut;                                    // 0x0FC2(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_FC3[0x5];                                      // 0x0FC3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonLazyImage*                       LazyImage_PlayerPortrait;                          // 0x0FC8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USizeBox*                               Size_Ghost;                                        // 0x0FD0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonTextBlock*                       Text_PlayerNumber;                                 // 0x0FD8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatPlayerEntry) == 0x000FE0, "Wrong size on UMoleQuickChatPlayerEntry");
static_assert(offsetof(UMoleQuickChatPlayerEntry, PlayerPortraitColorAMaterialParameterName) == 0x000F98, "Member 'UMoleQuickChatPlayerEntry::PlayerPortraitColorAMaterialParameterName' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, PlayerPortraitColorBMaterialParameterName) == 0x000F9C, "Member 'UMoleQuickChatPlayerEntry::PlayerPortraitColorBMaterialParameterName' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, bIsOnLowerRow) == 0x000FA0, "Member 'UMoleQuickChatPlayerEntry::bIsOnLowerRow' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, PlayerState) == 0x000FA8, "Member 'UMoleQuickChatPlayerEntry::PlayerState' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, PlayerName) == 0x000FB0, "Member 'UMoleQuickChatPlayerEntry::PlayerName' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, bIsLocalPlayer) == 0x000FC0, "Member 'UMoleQuickChatPlayerEntry::bIsLocalPlayer' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, bIsGhost) == 0x000FC1, "Member 'UMoleQuickChatPlayerEntry::bIsGhost' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, bIsFilteredOut) == 0x000FC2, "Member 'UMoleQuickChatPlayerEntry::bIsFilteredOut' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, LazyImage_PlayerPortrait) == 0x000FC8, "Member 'UMoleQuickChatPlayerEntry::LazyImage_PlayerPortrait' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, Size_Ghost) == 0x000FD0, "Member 'UMoleQuickChatPlayerEntry::Size_Ghost' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayerEntry, Text_PlayerNumber) == 0x000FD8, "Member 'UMoleQuickChatPlayerEntry::Text_PlayerNumber' has a wrong offset!");
...
{
public:
	bool                                          bIsSkipButtonEnabled;                              // 0x03B8(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_3B9[0x7];                                      // 0x03B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UOverlay*                               Overlay_Players;                                   // 0x03C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonButtonBase*                      Button_Skip;                                       // 0x03C8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3D0[0x48];                                     // 0x03D0(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputComponent*                        PlayersInputComponent;                             // 0x0418(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMoleQuickChatPlayerEntry*>      PlayerButtons;                                     // 0x0420(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatPlayersWidget) == 0x000438, "Wrong size on UMoleQuickChatPlayersWidget");
static_assert(offsetof(UMoleQuickChatPlayersWidget, bIsSkipButtonEnabled) == 0x0003B8, "Member 'UMoleQuickChatPlayersWidget::bIsSkipButtonEnabled' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayersWidget, Overlay_Players) == 0x0003C0, "Member 'UMoleQuickChatPlayersWidget::Overlay_Players' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayersWidget, Button_Skip) == 0x0003C8, "Member 'UMoleQuickChatPlayersWidget::Button_Skip' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayersWidget, PlayersInputComponent) == 0x000418, "Member 'UMoleQuickChatPlayersWidget::PlayersInputComponent' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatPlayersWidget, PlayerButtons) == 0x000420, "Member 'UMoleQuickChatPlayersWidget::PlayerButtons' has a wrong offset!");
...
public:
	...
	class URichTextBlock*                         Text_Sender;                                       // 0x0280(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class URichTextBlock*                         Text_Message;                                      // 0x0288(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsFromSelf;                                       // 0x0290(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsFromPreviousSender;                             // 0x0291(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_292[0x6];                                      // 0x0292(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerState*                           PlayerState;                                       // 0x0298(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UFortItemDefinition*                    PlayerItemDefinition;                              // 0x02A0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMoleQuickChatMessageEntry) == 0x0002A8, "Wrong size on UMoleQuickChatMessageEntry");
static_assert(offsetof(UMoleQuickChatMessageEntry, Text_Sender) == 0x000280, "Member 'UMoleQuickChatMessageEntry::Text_Sender' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMessageEntry, Text_Message) == 0x000288, "Member 'UMoleQuickChatMessageEntry::Text_Message' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMessageEntry, bIsFromSelf) == 0x000290, "Member 'UMoleQuickChatMessageEntry::bIsFromSelf' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMessageEntry, bIsFromPreviousSender) == 0x000291, "Member 'UMoleQuickChatMessageEntry::bIsFromPreviousSender' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMessageEntry, PlayerState) == 0x000298, "Member 'UMoleQuickChatMessageEntry::PlayerState' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatMessageEntry, PlayerItemDefinition) == 0x0002A0, "Member 'UMoleQuickChatMessageEntry::PlayerItemDefinition' has a wrong offset!");
...
{
public:
	struct FLinearColor                           CategoryColor;                                     // 0x1038(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UTexture2D>              CategoryImage;                                     // 0x1048(0x0028)(BlueprintVisible, BlueprintReadOnly, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonRichTextBlock*                   RichText_Main;                                     // 0x1070(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatRadialSlot) == 0x001080, "Wrong size on UMoleQuickChatRadialSlot");
static_assert(offsetof(UMoleQuickChatRadialSlot, CategoryColor) == 0x001038, "Member 'UMoleQuickChatRadialSlot::CategoryColor' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatRadialSlot, CategoryImage) == 0x001048, "Member 'UMoleQuickChatRadialSlot::CategoryImage' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatRadialSlot, RichText_Main) == 0x001070, "Member 'UMoleQuickChatRadialSlot::RichText_Main' has a wrong offset!");
...
static_assert(sizeof(UMoleQuickChatCategorySlot) == 0x001080, "Wrong size on UMoleQuickChatCategorySlot");
...
static_assert(sizeof(UMoleQuickChatActionSlot) == 0x001080, "Wrong size on UMoleQuickChatActionSlot");
...
{
public:
	class FText                                   LeftBracketToken;                                  // 0x03B8(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   RightBracketToken;                                 // 0x03D0(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddPlayerToken;                                    // 0x03E8(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddPlayerOptionalToken;                            // 0x0400(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddPlayerTitleToken;                               // 0x0418(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddGhostToken;                                     // 0x0430(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddGhostOptionalToken;                             // 0x0448(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddGhostTitleToken;                                // 0x0460(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddLocationToken;                                  // 0x0478(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddLocationOptionalToken;                          // 0x0490(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   AddLocationTitleToken;                             // 0x04A8(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	class FText                                   SelectedTokenFormat;                               // 0x04C0(0x0018)(Edit, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UMoleQuickChatRadialSlot>   CategoryWidgetClass;                               // 0x04D8(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UMoleQuickChatRadialSlot>   ActionWidgetClass;                                 // 0x04E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FMoleBlockedInput>              InputActionsToBlock;                               // 0x04E8(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FMoleHoldBinding                       BackBinding;                                       // 0x04F8(0x0018)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	class UOverlay*                               Overlay_Selections;                                // 0x0510(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonVisibilitySwitcher*              Switcher_SelectionMethods;                         // 0x0518(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOverlay*                               Overlay_Radial;                                    // 0x0520(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOverlay*                               Overlay_Players;                                   // 0x0528(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOverlay*                               Overlay_Map;                                       // 0x0530(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMoleSlottedRadialMenu*                 Radial_Selections;                                 // 0x0538(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMoleQuickChatPlayersWidget*            MolePlayers_PlayerSelection;                       // 0x0540(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMoleQuickChatMap*                      MoleMap_LocationSelection;                         // 0x0548(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USizeBox*                               SizeBox_HotkeyBar;                                 // 0x0550(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOverlay*                               Overlay_FullscreenContainer;                       // 0x0558(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_560[0x50];                                     // 0x0560(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputComponent*                        QuickChatInputComponent;                           // 0x05B0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatWidget) == 0x0005C8, "Wrong size on UMoleQuickChatWidget");
static_assert(offsetof(UMoleQuickChatWidget, LeftBracketToken) == 0x0003B8, "Member 'UMoleQuickChatWidget::LeftBracketToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, RightBracketToken) == 0x0003D0, "Member 'UMoleQuickChatWidget::RightBracketToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddPlayerToken) == 0x0003E8, "Member 'UMoleQuickChatWidget::AddPlayerToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddPlayerOptionalToken) == 0x000400, "Member 'UMoleQuickChatWidget::AddPlayerOptionalToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddPlayerTitleToken) == 0x000418, "Member 'UMoleQuickChatWidget::AddPlayerTitleToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddGhostToken) == 0x000430, "Member 'UMoleQuickChatWidget::AddGhostToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddGhostOptionalToken) == 0x000448, "Member 'UMoleQuickChatWidget::AddGhostOptionalToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddGhostTitleToken) == 0x000460, "Member 'UMoleQuickChatWidget::AddGhostTitleToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddLocationToken) == 0x000478, "Member 'UMoleQuickChatWidget::AddLocationToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddLocationOptionalToken) == 0x000490, "Member 'UMoleQuickChatWidget::AddLocationOptionalToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, AddLocationTitleToken) == 0x0004A8, "Member 'UMoleQuickChatWidget::AddLocationTitleToken' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, SelectedTokenFormat) == 0x0004C0, "Member 'UMoleQuickChatWidget::SelectedTokenFormat' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, CategoryWidgetClass) == 0x0004D8, "Member 'UMoleQuickChatWidget::CategoryWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, ActionWidgetClass) == 0x0004E0, "Member 'UMoleQuickChatWidget::ActionWidgetClass' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, InputActionsToBlock) == 0x0004E8, "Member 'UMoleQuickChatWidget::InputActionsToBlock' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, BackBinding) == 0x0004F8, "Member 'UMoleQuickChatWidget::BackBinding' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Overlay_Selections) == 0x000510, "Member 'UMoleQuickChatWidget::Overlay_Selections' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Switcher_SelectionMethods) == 0x000518, "Member 'UMoleQuickChatWidget::Switcher_SelectionMethods' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Overlay_Radial) == 0x000520, "Member 'UMoleQuickChatWidget::Overlay_Radial' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Overlay_Players) == 0x000528, "Member 'UMoleQuickChatWidget::Overlay_Players' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Overlay_Map) == 0x000530, "Member 'UMoleQuickChatWidget::Overlay_Map' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Radial_Selections) == 0x000538, "Member 'UMoleQuickChatWidget::Radial_Selections' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, MolePlayers_PlayerSelection) == 0x000540, "Member 'UMoleQuickChatWidget::MolePlayers_PlayerSelection' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, MoleMap_LocationSelection) == 0x000548, "Member 'UMoleQuickChatWidget::MoleMap_LocationSelection' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, SizeBox_HotkeyBar) == 0x000550, "Member 'UMoleQuickChatWidget::SizeBox_HotkeyBar' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, Overlay_FullscreenContainer) == 0x000558, "Member 'UMoleQuickChatWidget::Overlay_FullscreenContainer' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidget, QuickChatInputComponent) == 0x0005B0, "Member 'UMoleQuickChatWidget::QuickChatInputComponent' has a wrong offset!");
...
{
public:
	TSubclassOf<class UMoleQuickChatUIComponent>  QuickChatUIComponentClass;                         // 0x0278(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftClassPtr<class UClass>                   ActiveClass;                                       // 0x0280(0x0028)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleQuickChatWidgetProxy) == 0x0002C0, "Wrong size on UMoleQuickChatWidgetProxy");
static_assert(offsetof(UMoleQuickChatWidgetProxy, QuickChatUIComponentClass) == 0x000278, "Member 'UMoleQuickChatWidgetProxy::QuickChatUIComponentClass' has a wrong offset!");
static_assert(offsetof(UMoleQuickChatWidgetProxy, ActiveClass) == 0x000280, "Member 'UMoleQuickChatWidgetProxy::ActiveClass' has a wrong offset!");
...
{
public:
	class FText                                   Name_0;                                            // 0x0278(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	class FName                                   TriggeringInputAction;                             // 0x0290(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_294[0x4];                                      // 0x0294(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  AbilitiesToTrack;                                  // 0x0298(0x0020)(Edit, NativeAccessSpecifierPrivate)
	bool                                          bTrackLowestCooldown;                              // 0x02B8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B9[0x7];                                      // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayAbilitySpec>           AbilitySpecsToTrack;                               // 0x02C0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	class UMoleTimer*                             Timer_EntryVisuals;                                // 0x02D0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleSaboteurBarEntry) == 0x0002D8, "Wrong size on UMoleSaboteurBarEntry");
static_assert(offsetof(UMoleSaboteurBarEntry, Name_0) == 0x000278, "Member 'UMoleSaboteurBarEntry::Name_0' has a wrong offset!");
static_assert(offsetof(UMoleSaboteurBarEntry, TriggeringInputAction) == 0x000290, "Member 'UMoleSaboteurBarEntry::TriggeringInputAction' has a wrong offset!");
static_assert(offsetof(UMoleSaboteurBarEntry, AbilitiesToTrack) == 0x000298, "Member 'UMoleSaboteurBarEntry::AbilitiesToTrack' has a wrong offset!");
static_assert(offsetof(UMoleSaboteurBarEntry, bTrackLowestCooldown) == 0x0002B8, "Member 'UMoleSaboteurBarEntry::bTrackLowestCooldown' has a wrong offset!");
static_assert(offsetof(UMoleSaboteurBarEntry, AbilitySpecsToTrack) == 0x0002C0, "Member 'UMoleSaboteurBarEntry::AbilitySpecsToTrack' has a wrong offset!");
static_assert(offsetof(UMoleSaboteurBarEntry, Timer_EntryVisuals) == 0x0002D0, "Member 'UMoleSaboteurBarEntry::Timer_EntryVisuals' has a wrong offset!");
...
{
public:
	class FName                                   PointerRotationMaterialParameterName;              // 0x0388(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         AngleChangedEpsilon;                               // 0x038C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UImage*                                 Image_Pointer;                                     // 0x0390(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleSlottedRadialMenu) == 0x0003A0, "Wrong size on UMoleSlottedRadialMenu");
static_assert(offsetof(UMoleSlottedRadialMenu, PointerRotationMaterialParameterName) == 0x000388, "Member 'UMoleSlottedRadialMenu::PointerRotationMaterialParameterName' has a wrong offset!");
static_assert(offsetof(UMoleSlottedRadialMenu, AngleChangedEpsilon) == 0x00038C, "Member 'UMoleSlottedRadialMenu::AngleChangedEpsilon' has a wrong offset!");
static_assert(offsetof(UMoleSlottedRadialMenu, Image_Pointer) == 0x000390, "Member 'UMoleSlottedRadialMenu::Image_Pointer' has a wrong offset!");
...
{
public:
	float                                         MaximumRelativeHeightBeforeOffset;                 // 0x0360(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CollisionRelativeHeightOffset;                     // 0x0364(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         bIsScreenClamped : 1;                              // 0x0368(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(UMoleSubobjectiveIndicatorWidget) == 0x000370, "Wrong size on UMoleSubobjectiveIndicatorWidget");
static_assert(offsetof(UMoleSubobjectiveIndicatorWidget, MaximumRelativeHeightBeforeOffset) == 0x000360, "Member 'UMoleSubobjectiveIndicatorWidget::MaximumRelativeHeightBeforeOffset' has a wrong offset!");
static_assert(offsetof(UMoleSubobjectiveIndicatorWidget, CollisionRelativeHeightOffset) == 0x000364, "Member 'UMoleSubobjectiveIndicatorWidget::CollisionRelativeHeightOffset' has a wrong offset!");
...
{
public:
	class UDynamicEntryBox*                       ObjectiveEntryBox;                                 // 0x0278(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UUserWidget*                            TaskProgress;                                      // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMolePlayerTaskManagementComponent*     CachedOwningTaskComponent;                         // 0x0288(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoleTaskDataAsset*                     CachedTaskDataAsset;                               // 0x0290(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FMoleActiveTaskStateHandle             CachedTaskHandle;                                  // 0x0298(0x0004)(Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_29C[0xC];                                      // 0x029C(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bAttemptShowActiveObjectives : 1;                  // 0x02A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
static_assert(sizeof(UMoleTaskHUDWidget) == 0x0002B0, "Wrong size on UMoleTaskHUDWidget");
static_assert(offsetof(UMoleTaskHUDWidget, ObjectiveEntryBox) == 0x000278, "Member 'UMoleTaskHUDWidget::ObjectiveEntryBox' has a wrong offset!");
static_assert(offsetof(UMoleTaskHUDWidget, TaskProgress) == 0x000280, "Member 'UMoleTaskHUDWidget::TaskProgress' has a wrong offset!");
static_assert(offsetof(UMoleTaskHUDWidget, CachedOwningTaskComponent) == 0x000288, "Member 'UMoleTaskHUDWidget::CachedOwningTaskComponent' has a wrong offset!");
static_assert(offsetof(UMoleTaskHUDWidget, CachedTaskDataAsset) == 0x000290, "Member 'UMoleTaskHUDWidget::CachedTaskDataAsset' has a wrong offset!");
static_assert(offsetof(UMoleTaskHUDWidget, CachedTaskHandle) == 0x000298, "Member 'UMoleTaskHUDWidget::CachedTaskHandle' has a wrong offset!");
...
static_assert(sizeof(UMoleTaskObjectiveHUDWidget) == 0x000280, "Wrong size on UMoleTaskObjectiveHUDWidget");
...
static_assert(sizeof(UMoleTimer) == 0x000288, "Wrong size on UMoleTimer");
...
static_assert(sizeof(UMoleVoiceChatStatusIcon) == 0x000280, "Wrong size on UMoleVoiceChatStatusIcon");
...
{
public:
	class UCommonListView*                        ListView_EliminatedPlayers;                        // 0x0278(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonListView*                        ListView_Voters;                                   // 0x0280(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonListView*                        ListView_Saboteurs;                                // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleVoteCastingInfoPanel) == 0x000290, "Wrong size on UMoleVoteCastingInfoPanel");
static_assert(offsetof(UMoleVoteCastingInfoPanel, ListView_EliminatedPlayers) == 0x000278, "Member 'UMoleVoteCastingInfoPanel::ListView_EliminatedPlayers' has a wrong offset!");
static_assert(offsetof(UMoleVoteCastingInfoPanel, ListView_Voters) == 0x000280, "Member 'UMoleVoteCastingInfoPanel::ListView_Voters' has a wrong offset!");
static_assert(offsetof(UMoleVoteCastingInfoPanel, ListView_Saboteurs) == 0x000288, "Member 'UMoleVoteCastingInfoPanel::ListView_Saboteurs' has a wrong offset!");
...
{
public:
	TArray<class APlayerState*>                   VoteList;                                          // 0x0278(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_288[0x10];                                     // 0x0288(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class UCommonTileView*                        TileView_Votes;                                    // 0x0298(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoleVoteTally) == 0x0002A0, "Wrong size on UMoleVoteTally");
static_assert(offsetof(UMoleVoteTally, VoteList) == 0x000278, "Member 'UMoleVoteTally::VoteList' has a wrong offset!");
static_assert(offsetof(UMoleVoteTally, TileView_Votes) == 0x000298, "Member 'UMoleVoteTally::TileView_Votes' has a wrong offset!");
