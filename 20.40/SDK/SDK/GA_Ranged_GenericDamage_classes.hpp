...
{
public:
	struct FGameplayTag                           GT_EventWeaponFire;                                // 0x0AF0(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          ManualFireEvent;                                   // 0x0AF4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_Ranged_GenericDamage_C) == 0x000AF8, "Wrong size on UGA_Ranged_GenericDamage_C");
...
static_assert(offsetof(UGA_Ranged_GenericDamage_C, ManualFireEvent) == 0x000AF4, "Member 'UGA_Ranged_GenericDamage_C::ManualFireEvent' has a wrong offset!");
