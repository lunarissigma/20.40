...
{
public:
	class UImage*                                 Image_63;                                          // 0x0328(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(USidebarProfileSubPanelRegion_C) == 0x000330, "Wrong size on USidebarProfileSubPanelRegion_C");
static_assert(offsetof(USidebarProfileSubPanelRegion_C, Image_63) == 0x000328, "Member 'USidebarProfileSubPanelRegion_C::Image_63' has a wrong offset!");
