...
static_assert(sizeof(UGameFeaturePluginStateMachine) == 0x0001C0, "Wrong size on UGameFeaturePluginStateMachine");
...
static_assert(sizeof(UGameFeaturesSubsystemSettings) == 0x000078, "Wrong size on UGameFeaturesSubsystemSettings");
...
static_assert(offsetof(UGameFeaturesSubsystemSettings, BuiltInGameFeaturePluginsFolder) == 0x000068, "Member 'UGameFeaturesSubsystemSettings::BuiltInGameFeaturePluginsFolder' has a wrong offset!");
