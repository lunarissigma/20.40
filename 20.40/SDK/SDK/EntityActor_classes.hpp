...
static_assert(alignof(IEntityAbilityInterface) == 0x000001, "Wrong alignment on IEntityAbilityInterface");
static_assert(sizeof(IEntityAbilityInterface) == 0x000001, "Wrong size on IEntityAbilityInterface");
