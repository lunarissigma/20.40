...
public:
	...
	TSubclassOf<class APlayspace>                 PlayspaceClass;                                    // 0x0298(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class APlayspace*                             Playspace;                                         // 0x02A0(0x0008)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                  VolumeTags;                                        // 0x02A8(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Net, Protected, NativeAccessSpecifierProtected)
	class UOverlapComponent*                      BoundsComponent;                                   // 0x02C8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayVolume) == 0x0002F0, "Wrong size on AGameplayVolume");
...
static_assert(offsetof(AGameplayVolume, PlayspaceClass) == 0x000298, "Member 'AGameplayVolume::PlayspaceClass' has a wrong offset!");
static_assert(offsetof(AGameplayVolume, Playspace) == 0x0002A0, "Member 'AGameplayVolume::Playspace' has a wrong offset!");
static_assert(offsetof(AGameplayVolume, VolumeTags) == 0x0002A8, "Member 'AGameplayVolume::VolumeTags' has a wrong offset!");
static_assert(offsetof(AGameplayVolume, BoundsComponent) == 0x0002C8, "Member 'AGameplayVolume::BoundsComponent' has a wrong offset!");
...
public:
	...
	bool                                          bUsePlayerSpawningComponent;                       // 0x07D8(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7D9[0x7];                                      // 0x07D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UPlayspaceControllerComponent_PlayerSpawning> ControllerSpawningComponent;     // 0x07E0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(APlayspacePlayerController) == 0x0007E8, "Wrong size on APlayspacePlayerController");
static_assert(offsetof(APlayspacePlayerController, bUsePlayerSpawningComponent) == 0x0007D8, "Member 'APlayspacePlayerController::bUsePlayerSpawningComponent' has a wrong offset!");
static_assert(offsetof(APlayspacePlayerController, ControllerSpawningComponent) == 0x0007E0, "Member 'APlayspacePlayerController::ControllerSpawningComponent' has a wrong offset!");
...
static_assert(sizeof(APlayspaceGameMode) == 0x000370, "Wrong size on APlayspaceGameMode");
