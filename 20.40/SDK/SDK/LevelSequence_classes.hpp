...
public:
	...
	class ULevelSequence*                         LevelSequenceAsset;                                // 0x02A8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ALevelSequenceActor) == 0x0002E8, "Wrong size on ALevelSequenceActor");
static_assert(offsetof(ALevelSequenceActor, PlaybackSettings) == 0x000288, "Member 'ALevelSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x0002A0, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequenceAsset) == 0x0002A8, "Member 'ALevelSequenceActor::LevelSequenceAsset' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x0002B0, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x0002B8, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x0002C0, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, DefaultInstanceData) == 0x0002D0, "Member 'ALevelSequenceActor::DefaultInstanceData' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x0002D8, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x0002E0, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x0278(0x00A8)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x0320(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000328, "Wrong size on ULevelSequenceBurnIn");
...
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000320, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
static_assert(sizeof(ULevelSequencePlayer) == 0x0005F8, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x000500, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
static_assert(sizeof(ALevelSequenceMediaController) == 0x000298, "Wrong size on ALevelSequenceMediaController");
static_assert(offsetof(ALevelSequenceMediaController, Sequence) == 0x000278, "Member 'ALevelSequenceMediaController::Sequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, MediaComponent) == 0x000280, "Member 'ALevelSequenceMediaController::MediaComponent' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, ServerStartTimeSeconds) == 0x000288, "Member 'ALevelSequenceMediaController::ServerStartTimeSeconds' has a wrong offset!");
