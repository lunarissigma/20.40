...
struct VKConnectionIndicator_OnConnectionToEditChanged final
{
public:
...
static_assert(alignof(VKConnectionIndicator_OnConnectionToEditChanged) == 0x000001, "Wrong alignment on VKConnectionIndicator_OnConnectionToEditChanged");
static_assert(sizeof(VKConnectionIndicator_OnConnectionToEditChanged) == 0x000001, "Wrong size on VKConnectionIndicator_OnConnectionToEditChanged");
static_assert(offsetof(VKConnectionIndicator_OnConnectionToEditChanged, bConnected) == 0x000000, "Member 'VKConnectionIndicator_OnConnectionToEditChanged::bConnected' has a wrong offset!");
