...
static_assert(sizeof(UCreativeModalDialogWidget) == 0x0003C8, "Wrong size on UCreativeModalDialogWidget");
static_assert(offsetof(UCreativeModalDialogWidget, MainMenuInputRowHandle) == 0x0003B8, "Member 'UCreativeModalDialogWidget::MainMenuInputRowHandle' has a wrong offset!");
