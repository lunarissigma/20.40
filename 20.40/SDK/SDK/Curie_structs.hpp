...
{
public:
	TArray<TSubclassOf<class UCurieElementAttachHandler>> ElementAttachHandlers;                     // 0x0008(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPrivate)
	TSubclassOf<class UCurieElementAttachConditionHandler> ElementAttachConditionHandler;            // 0x0018(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<TSubclassOf<class UCurieElementInteractWithElementHandler>> ElementInteractHandlers;      // 0x0020(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<TSubclassOf<class UCurieElementInteractWithMaterialHandler>> ElementMaterialInteractHandlers; // 0x0030(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<TSubclassOf<class UCurieElementInteractWithContainerHandler>> ElementContainerInteractHandlers; // 0x0040(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FGameplayTagContainer                  ElementalImmunities;                               // 0x0050(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	uint8                                         bIsEnabled : 1;                                    // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FCurieElementDefinitionBase) == 0x000008, "Wrong alignment on FCurieElementDefinitionBase");
static_assert(sizeof(FCurieElementDefinitionBase) == 0x000078, "Wrong size on FCurieElementDefinitionBase");
static_assert(offsetof(FCurieElementDefinitionBase, ElementAttachHandlers) == 0x000008, "Member 'FCurieElementDefinitionBase::ElementAttachHandlers' has a wrong offset!");
static_assert(offsetof(FCurieElementDefinitionBase, ElementAttachConditionHandler) == 0x000018, "Member 'FCurieElementDefinitionBase::ElementAttachConditionHandler' has a wrong offset!");
static_assert(offsetof(FCurieElementDefinitionBase, ElementInteractHandlers) == 0x000020, "Member 'FCurieElementDefinitionBase::ElementInteractHandlers' has a wrong offset!");
static_assert(offsetof(FCurieElementDefinitionBase, ElementMaterialInteractHandlers) == 0x000030, "Member 'FCurieElementDefinitionBase::ElementMaterialInteractHandlers' has a wrong offset!");
static_assert(offsetof(FCurieElementDefinitionBase, ElementContainerInteractHandlers) == 0x000040, "Member 'FCurieElementDefinitionBase::ElementContainerInteractHandlers' has a wrong offset!");
static_assert(offsetof(FCurieElementDefinitionBase, ElementalImmunities) == 0x000050, "Member 'FCurieElementDefinitionBase::ElementalImmunities' has a wrong offset!");
