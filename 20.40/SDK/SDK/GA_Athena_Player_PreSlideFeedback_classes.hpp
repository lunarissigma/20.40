...
static_assert(sizeof(UGA_Athena_Player_PreSlideFeedback_C) == 0x000AC0, "Wrong size on UGA_Athena_Player_PreSlideFeedback_C");
static_assert(offsetof(UGA_Athena_Player_PreSlideFeedback_C, UberGraphFrame) == 0x000AB8, "Member 'UGA_Athena_Player_PreSlideFeedback_C::UberGraphFrame' has a wrong offset!");
