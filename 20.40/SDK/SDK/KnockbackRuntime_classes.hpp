...
public:
	...
	TMulticastInlineDelegate<void(const struct FKnockbackMutatorData& KnockbackData)> OnPlayerKnockbackDataChanged; // 0x0320(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	class AFortAthenaMutator_Knockback*           CachedMutator;                                     // 0x0AB8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class AFortAthenaMutator_Knockback> MutatorClassToGet;                               // 0x0AC0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortGameplayAbility_KnockbackMutator) == 0x000AC8, "Wrong size on UFortGameplayAbility_KnockbackMutator");
static_assert(offsetof(UFortGameplayAbility_KnockbackMutator, CachedMutator) == 0x000AB8, "Member 'UFortGameplayAbility_KnockbackMutator::CachedMutator' has a wrong offset!");
static_assert(offsetof(UFortGameplayAbility_KnockbackMutator, MutatorClassToGet) == 0x000AC0, "Member 'UFortGameplayAbility_KnockbackMutator::MutatorClassToGet' has a wrong offset!");
