...
static_assert(sizeof(AFrontEnd_GameMode_C) == 0x000728, "Wrong size on AFrontEnd_GameMode_C");
static_assert(offsetof(AFrontEnd_GameMode_C, DefaultSceneRoot) == 0x000720, "Member 'AFrontEnd_GameMode_C::DefaultSceneRoot' has a wrong offset!");
