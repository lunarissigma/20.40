...
static_assert(sizeof(ADA_Glider_Item_C) == 0x001048, "Wrong size on ADA_Glider_Item_C");
static_assert(offsetof(ADA_Glider_Item_C, UberGraphFrame) == 0x001020, "Member 'ADA_Glider_Item_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReason) == 0x001028, "Member 'ADA_Glider_Item_C::ErrorReason' has a wrong offset!");
