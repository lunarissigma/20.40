...
public:
	...
	bool                                          bForwardToActorOwner;                              // 0x0030(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bForwardToAttachedActors;                          // 0x0031(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool PlaySound(class USoundBase* Sound, struct FSoundLibraryPlaySoundResult* OutResults) const;
...
static_assert(offsetof(USoundLibraryContext, bForwardToActorOwner) == 0x000030, "Member 'USoundLibraryContext::bForwardToActorOwner' has a wrong offset!");
static_assert(offsetof(USoundLibraryContext, bForwardToAttachedActors) == 0x000031, "Member 'USoundLibraryContext::bForwardToAttachedActors' has a wrong offset!");
...
public:
	...
	struct FSoundLibraryPlaySoundResult           PlaybackResult;                                    // 0x0038(0x0028)(Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USoundLibraryAnimNotifyHelper) == 0x000060, "Wrong size on USoundLibraryAnimNotifyHelper");
...
public:
	...
	TArray<class USoundLibrary*>                  Libraries;                                         // 0x00D0(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(offsetof(USoundLibraryComponent, SoundLibraries) == 0x0000C0, "Member 'USoundLibraryComponent::SoundLibraries' has a wrong offset!");
static_assert(offsetof(USoundLibraryComponent, Libraries) == 0x0000D0, "Member 'USoundLibraryComponent::Libraries' has a wrong offset!");
...
static_assert(alignof(ISoundLibraryProviderInterface) == 0x000001, "Wrong alignment on ISoundLibraryProviderInterface");
static_assert(sizeof(ISoundLibraryProviderInterface) == 0x000001, "Wrong size on ISoundLibraryProviderInterface");
...
{
public:
	struct FAttachedSoundLibraryContextSettings   Settings;                                          // 0x0058(0x0050)(Edit, BlueprintVisible, NoDestructor, ExposeOnSpawn, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAttachedSoundLibraryContext) == 0x0000A8, "Wrong size on UAttachedSoundLibraryContext");
static_assert(offsetof(UAttachedSoundLibraryContext, Settings) == 0x000058, "Member 'UAttachedSoundLibraryContext::Settings' has a wrong offset!");
...
static_assert(sizeof(USoundLibrary) == 0x000150, "Wrong size on USoundLibrary");
