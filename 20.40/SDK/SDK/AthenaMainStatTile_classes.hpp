...
static_assert(sizeof(UAthenaMainStatTile_C) == 0x0002C0, "Wrong size on UAthenaMainStatTile_C");
static_assert(offsetof(UAthenaMainStatTile_C, Glow) == 0x0002B8, "Member 'UAthenaMainStatTile_C::Glow' has a wrong offset!");
