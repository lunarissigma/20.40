...
static_assert(sizeof(MediaSoundComponent_BP_GetAttenuationSettingsToApply) == 0x0003B0, "Wrong size on MediaSoundComponent_BP_GetAttenuationSettingsToApply");
...
static_assert(offsetof(MediaSoundComponent_BP_GetAttenuationSettingsToApply, ReturnValue) == 0x0003A8, "Member 'MediaSoundComponent_BP_GetAttenuationSettingsToApply::ReturnValue' has a wrong offset!");
